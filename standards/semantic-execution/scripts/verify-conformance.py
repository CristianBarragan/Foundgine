...
# Ensure every layer 0-26 has at least one requirement and no duplicate IDs.
for n in range(27):
...
print("OK: all SES layers L0-L26 contain explicit test requirements")
for f in [
    "SES-100-conformance-testing.md",
    "SES-101-test-architecture-and-fixtures.md",
    "SES-102-conformance-matrix.md",
    "SES-103-security-conformance.md",
    "SES-104-foundgine-test-mapping.md",
    "SES-105-conformance-vectors.md",
]:
