...
public final class SupplyChainDomain {
    ...
    public record BusinessUnit(
            int id, @FoundgineSemanticDimension("company") int companyId, String name) {}

    @FoundgineEntity(name = "Warehouse")
    public record Warehouse(
            int id,
            @FoundgineSemanticDimension("businessUnit") int businessUnitId,
            String name,
    ...
    @FoundgineAlias(value = "purchase", weight = 90)
    ...
    public record PurchaseOrderLine(
            int id, int purchaseOrderId, int productId, int quantity, BigDecimal unitCost) {}
    ...
    public record CustomerOrderLine(
            int id, int customerOrderId, int productId, int quantity, BigDecimal unitPrice) {}
    ...
    public record ComplianceIncident(
            int id, int supplierId, String severity, String description, LocalDate occurredAt) {}
