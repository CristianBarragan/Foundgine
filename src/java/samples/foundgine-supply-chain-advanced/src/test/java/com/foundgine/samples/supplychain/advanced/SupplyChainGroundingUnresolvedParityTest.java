...
class SupplyChainGroundingUnresolvedParityTest {
    @Test
    void unknownBusinessThresholdTermFailsClosed() {
        var source =
                source(
        ...
        assertEquals(
                ...
                r.resolve("risky suppliers").outcome());
    }

    @Test
    void unsupportedRelativeDateTermFailsClosed() {
        var source =
                source(
                        new SemanticLexicalCandidate(
                                "delayed",
                                ...
                                .93,
                                SupplyChainSemanticModel.SHIPMENT,
                                null,
                                SupplyChainSemanticModel.field("Shipment", "Status"),
                                null,
                                null,
                                "Delayed",
                                List.of()),
        ...
        var d =
                new SemanticLexicalResolver(SupplyChainSemanticModel.MODEL.createSnapshot(), source)
                        .ground("delayed shipments last month");
        assertEquals(GroundingOutcome.UNRESOLVED, d.outcome());
        assertNull(d.committed());
