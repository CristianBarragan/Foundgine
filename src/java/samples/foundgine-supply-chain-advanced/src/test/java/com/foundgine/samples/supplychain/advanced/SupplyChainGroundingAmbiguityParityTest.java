...
class SupplyChainGroundingAmbiguityParityTest {
    @Test
    void activeSupplierMeaningRequiresClarification() {
        ...
        var source =
                source(
                        ...
                        new SemanticLexicalCandidate(
                                "active",
                                SemanticLexicalCandidateKind.VALUE,
                                "SupplierCertification.ValidTo >= today",
                                .895,
                                SupplyChainSemanticModel.CERTIFICATION,
                                null,
                                SupplyChainSemanticModel.field("SupplierCertification", "ValidTo"),
                                null,
                                null,
                                "current",
                                List.of()));
        ...
        assertEquals(
                SemanticLexicalResolutionOutcome.AMBIGUOUS, resolver.resolve("active").outcome());
    }

    @Test
    void duplicateEvidenceForSameRelationshipDoesNotCreateAmbiguity() {
        ...
        var source =
                source(
                        ...
                        new SemanticLexicalCandidate(
                                ...
                                List.of()));
        var decision =
                new SemanticLexicalResolver(SupplyChainSemanticModel.MODEL.createSnapshot(), source)
                        .ground("supplied");
    ...
    private ISemanticLexicalCandidateSource source(SemanticLexicalCandidate... candidates) {
        return request ->
                Arrays.stream(candidates)
                        ...
                        .sorted(
                                Comparator.comparingDouble(SemanticLexicalCandidate::score)
                                        .reversed())
                        .toList();
    }
}
