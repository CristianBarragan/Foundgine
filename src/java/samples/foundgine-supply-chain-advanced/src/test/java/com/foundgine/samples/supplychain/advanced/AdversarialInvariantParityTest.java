...
class AdversarialInvariantParityTest {
    @Test
    void documented_seed_and_scoped_tenant_pass() {
        assertDoesNotThrow(
                () ->
                        ScenariosAdversarialInvariants.assertAdversarialInvariants(
                                SupplyChainData.seed(),
    ...
    @Test
    void cross_tenant_warehouse_in_authorization_context_fails_closed() {
        var ex =
                assertThrows(
    ...
    @Test
    void missing_bom_cycle_fixture_is_rejected() {
        var d = new SupplyChainData();
        d.suppliers.add(
                new Supplier(1, "Kiwi Components", "NZ", new BigDecimal("0.22"), "tenant-a"));
        d.products.add(
                new Product(
                        1,
                        "MOTOR-X",
        ...
        d.components.add(
                new ProductComponent(
                        ...
                        BigDecimal.ZERO,
                        BigDecimal.ZERO));
        d.certifications.add(
                new SupplierCertification(
                        1, 1, "ISO9001", LocalDate.of(2024, 1, 1), LocalDate.of(2024, 12, 31)));
        var ex =
                assertThrows(
                        IllegalStateException.class,
                        () ->
    ...
    @Test
    void supplier_three_certification_not_expired_is_rejected() {
        var d = new SupplyChainData();
        d.suppliers.add(
                new Supplier(1, "Kiwi Components", "NZ", new BigDecimal("0.22"), "tenant-a"));
        ...
        d.certifications.add(
                new SupplierCertification(
                        1, 3, "ISO9001", LocalDate.of(2026, 1, 1), LocalDate.of(2026, 8, 26)));
        var ex =
                assertThrows(
                        IllegalStateException.class,
                        () ->
