...
/**
 * Proves the Advanced Supply Chain sample actually consumes the compile-time generated metadata
 * artifact instead of merely configuring the processor.
 */
class AotGeneratedMetadataIntegrationTest {
    ...
    void generatedRegistryContainsAnnotatedSupplyChainEntities() {
        ...
        var entities =
                StreamSupport.stream(registry.entities().spliterator(), false)
