...
public final class Domain {
  ...
  @FoundgineEntity(name="BusinessUnit") public record BusinessUnit(int id,@FoundgineSemanticDimension("company") @FoundgineField(index=true) int companyId,String name) {}
  ...
  @FoundgineEntity(name="Product") public record Product(@FoundgineRelationship(target=ProductComponent.class,foreignKey="parentProductId",principalKey="id",name="components") int id,@FoundgineRelationship(target=PurchaseOrderLine.class,foreignKey="productId",principalKey="id",name="purchaseOrderLines") String sku,@FoundgineRelationship(target=ProductComponent.class,foreignKey="componentProductId",principalKey="id",name="usedInComponents") String name,@FoundgineSemanticDimension("category") String category,BigDecimal safetyStock,BigDecimal unitPrice) {}
  @FoundgineEntity(name="ProductComponent") public record ProductComponent(@FoundgineField(isPrimaryKey=true) int parentProductId,@FoundgineRelationship(target=Product.class,foreignKey="id",principalKey="componentProductId",name="componentProduct") int componentProductId,BigDecimal quantityPerParent,LocalDate effectiveFrom,LocalDate effectiveTo,String revision,boolean phantom,BigDecimal yieldLossPercent,BigDecimal scrapFactor) {}
  ...
  public record Order(int id,int customerId,String status,BigDecimal totalAmount,LocalDate placedOn) {}
  public record OrderItem(int id,int orderId,int productId,int quantity,BigDecimal unitPrice) {}
  ...
  @FoundgineEntity(name="CustomerOrder") public record CustomerOrder(@FoundgineRelationship(target=CustomerOrderLine.class,foreignKey="customerOrderId",principalKey="id",name="lines") int id,int businessUnitId,LocalDate placedOn,String status) {}
