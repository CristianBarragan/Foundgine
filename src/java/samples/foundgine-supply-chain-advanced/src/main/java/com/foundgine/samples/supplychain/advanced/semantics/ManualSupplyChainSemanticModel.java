    ...
    public static SemanticModel build() {
        ...
        builder.entity(
                ...
                e -> {
                    ...
                    e.constraint(
                            FieldId.create("Product", "Sku"),
                            SemanticConstraint.pattern("^[A-Z0-9-]{3,32}$"));
                    ...
                    e.constraint(
                            FieldId.create("Product", "SafetyStock"),
                            SemanticConstraint.range(BigDecimal.ZERO, null));
        ...
        builder.entity(
                ...
                e -> {
                    e.identity(
                            FieldId.create("ProductComponent", "ParentProductId"),
                            "ParentProductId");
                    field(
                            e,
                            "ProductComponent",
                    ...
                    field(
                            ...
                            (byte)
                                    (SemanticFieldCapabilities.DEFAULT
                                            | SemanticFieldCapabilities.WRITABLE));
                    e.constraint(
                            FieldId.create("ProductComponent", "QuantityPerParent"),
                            SemanticConstraint.range(BigDecimal.ZERO, null));
