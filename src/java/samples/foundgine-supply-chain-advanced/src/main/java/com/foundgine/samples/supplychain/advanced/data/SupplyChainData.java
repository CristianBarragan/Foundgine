...
public final class SupplyChainData {
  ...
  public static SupplyChainData seed() {
    ...
    d.products.addAll(List.of(new Product(1,"MOTOR-X","Industrial Motor","Motors",bd("30"),bd("12.25")),new Product(2,"CTRL-X","Motor Controller","Controls",bd("40"),bd("19.50")),new Product(3,"PCB-X","Controller PCB","Electronics",bd("80"),bd("26.75")),new Product(4,"CAP-X","High Reliability Capacitor","Electronics",bd("120"),bd("34.00")),new Product(5,"RES-X","Precision Resistor","Electronics",bd("100"),bd("41.25")),new Product(6,"PACK-X","Customer Assembly","Finished Goods",bd("25"),bd("48.50"))));
