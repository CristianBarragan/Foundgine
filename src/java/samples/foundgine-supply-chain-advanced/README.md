...
> **New here?** This README covers *how to run it*. For the file-by-file "why" — mirroring the C#
...
client-supplied claims are validated and can only ever *narrow* an identity's access
