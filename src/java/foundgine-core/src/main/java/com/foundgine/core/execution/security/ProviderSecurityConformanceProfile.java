...
public record ProviderSecurityConformanceProfile(String provider, Collection<String> preservedSecurityInvariants,
		Collection<String> notes) {
	public ProviderSecurityConformanceProfile {
		Objects.requireNonNull(provider, "provider");
		preservedSecurityInvariants = List
				.copyOf(preservedSecurityInvariants == null ? List.of() : preservedSecurityInvariants);
