...
public interface SemanticExpression {
    ...
    record RelationshipReference(RelationshipId relationship, SemanticType type)
    ...
    record Unary(String operator, SemanticExpression operand, SemanticType type)
            implements SemanticExpression {
        public SemanticType resultType() {
            return type;
        }
    ...
    record Binary(
            String operator, SemanticExpression left, SemanticExpression right, SemanticType type)
            implements SemanticExpression {
        public SemanticType resultType() {
            return type;
        }
    ...
    record Logical(LogicalOperator operator, List<SemanticExpression> operands)
            implements SemanticExpression {
        public Logical {
    ...
    record Aggregate(
            AggregateExpressionKind aggregate,
    ...
    record Function(String name, List<SemanticExpression> arguments, SemanticType type)
            implements SemanticExpression {
        public Function {
    ...
    final class SemanticExpressionTypes {
        ...
        public static final SemanticType BOOLEAN =
                new SemanticType.Scalar(SemanticScalarKind.BOOLEAN);
