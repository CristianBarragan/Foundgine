 ...
 *
 * <p>Small provider-independent representation of an AOT authorization
 * predicate. It contains no expression trees and no executable delegates.
 *
 * <p>{@code name}, {@code value}, {@code left}, and {@code right} are
 * nullable; which ones are populated depends on {@code kind}, mirroring the
 * C# optional-parameter constructor.
 */
