...
public record SemanticMutationPlan(
        List<SemanticMutationOperationPlan> operations,
    ...
    public record SemanticMutationOperationPlan(
            String operationId,
            EntityId entity,
    ...
    public record SemanticMutationDependencyPlan(
