 ...
 *
 * <p>Executes an ordered mutation batch from the canonical provider-neutral
...
public interface IMutationBatchExecutionProvider {
     ...
     */
    default MutationBatchResult executeBatch(ExecutionMutationIR ir, ExecutionContext context, CancellationToken cancellationToken) {
