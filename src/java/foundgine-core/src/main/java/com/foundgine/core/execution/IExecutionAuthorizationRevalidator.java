 ...
 *
 * <p>
 * Revalidates authorization at the final execution boundary. Implementations
 * may consult a database, distributed authority, cache, or another trusted
 * control plane.
 *
 * <p>
 * Provided as a two-overload pair: the full method plus a default method that
 * forwards {@link CancellationToken#NONE}, for callers that don't need
 * cancellation.
 */
