...
public final class SemanticAggregateSemanticsCatalog {
    ...
    public static final SemanticAggregateSemantics COUNT = new SemanticAggregateSemantics(SemanticFilterAggregate.COUNT, SemanticEmptyCollectionResult.ZERO, SemanticNullInputBehavior.NEVER_NULL, SemanticDuplicateSensitivity.SENSITIVE);
    public static final SemanticAggregateSemantics MIN = new SemanticAggregateSemantics(SemanticFilterAggregate.MIN, SemanticEmptyCollectionResult.NULL, SemanticNullInputBehavior.IGNORES_NULL, SemanticDuplicateSensitivity.INSENSITIVE);
