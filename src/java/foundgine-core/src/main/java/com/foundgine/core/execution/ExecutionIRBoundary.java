...
public final class ExecutionIRBoundary {
    ...
    public static void ensureAuthorized(SemanticContractSnapshot contract,
                                        ExecutionIR ir,
        ...
        if (binding == null) throw new IllegalStateException("Execution IR is missing authorization provenance.");
    ...
    public static void ensureProviderPlan(SemanticContractSnapshot contract,
                                          ExecutionIR ir,
