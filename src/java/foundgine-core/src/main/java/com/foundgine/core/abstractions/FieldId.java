...
public record FieldId(long value) implements SemanticId {
    ...
    public static FieldId create(String semanticEntityName, String semanticFieldName) {
        return new FieldId(
                SemanticIdentity.hash(
                        SemanticIdentity.fieldKey(semanticEntityName, semanticFieldName)));
    }
    ...
    public static final class Serializer extends StdSerializer<FieldId> {
        ...
        @Override
        public void serialize(FieldId id, JsonGenerator generator, SerializerProvider provider)
                throws IOException {
    ...
    public static final class Deserializer extends StdDeserializer<FieldId> {
        ...
        @Override
        public FieldId deserialize(JsonParser parser, DeserializationContext context)
                throws IOException {
    ...
    public static final class KeySerializer
            extends com.fasterxml.jackson.databind.ser.std.StdSerializer<FieldId> {
