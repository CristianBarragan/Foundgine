...
public record MutationFieldValue(ColumnId column, Object value, MutationValueReference source) {
    ...
    public static MutationFieldValue fromPrevious(
            ColumnId column, int sourceOperationIndex, FieldId sourceField) {
        return new MutationFieldValue(
                column, null, new MutationValueReference(sourceOperationIndex, sourceField));
    }
}
