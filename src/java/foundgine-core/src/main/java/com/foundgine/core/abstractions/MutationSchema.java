 ...
 *
 * <p>Narrow, provider-neutral schema contract required by mutation planning. It deliberately
 * exposes stable identities and key mappings only; concrete metadata types remain outside the
 * planning layer.
 */
