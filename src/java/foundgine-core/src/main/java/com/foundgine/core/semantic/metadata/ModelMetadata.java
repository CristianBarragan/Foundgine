...
public record ModelMetadata(ModelId id, String name, EntityId entity, Integer minimumWeight) {
    ...
    public ModelMetadata(ModelId id, String name) { this(id,name,null,null); }
    public ModelMetadata(ModelId id, String name, EntityId entity) { this(id,name,entity,null); }
}
