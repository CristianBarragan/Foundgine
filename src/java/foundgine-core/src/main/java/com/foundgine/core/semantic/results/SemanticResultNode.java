...
public final class SemanticResultNode {
	...
	public SemanticResultNode(int planNodeId, EntityId entityId, Object identityValue, Map<FieldId, Object> values) {
	 ...
	 * {@code Foundgine.Core}, including {@code Foundgine.Core.Execution}). This
	 * port has no JPMS module boundary around the single {@code
	 * foundgine-core} artifact, so the closest equivalent is {@code public} rather
	 * than package-private (needed by {@code
