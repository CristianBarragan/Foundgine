...
public final class ResolutionResult {
    ...
    private ResolutionResult(ResolutionOutcome outcome, ResolvedReference resolved, String reason, List<ResolutionEvidence> evidence) {
        this.outcome = outcome; this.resolved = resolved; this.unresolvedReason = reason;
    ...
    public ResolutionOutcome outcome() { return outcome; }
    public ResolvedReference resolved() { return resolved; }
    public String unresolvedReason() { return unresolvedReason; }
    public List<ResolutionEvidence> evidence() { return evidence; }
}
