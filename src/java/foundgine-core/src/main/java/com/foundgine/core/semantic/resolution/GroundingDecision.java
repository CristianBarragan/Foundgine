...
public record GroundingDecision(
    ...
    public GroundingDecision {
        ...
        competingInterpretations =
                competingInterpretations == null
                        ? List.of()
                        : List.copyOf(competingInterpretations);
        ...
        partialInterpretationsAtCutoff =
                partialInterpretationsAtCutoff == null
                        ? List.of()
    ...
    public GroundingDecision(
            ...
            GroundingOutcome outcome,
            GroundingInterpretation committed,
            List<GroundingInterpretation> competing,
            String reason,
        ...
        this(
                ...
                List.of(),
                committed == null ? null : committed.effectiveAliasEvidence(),
                List.of());
    }
