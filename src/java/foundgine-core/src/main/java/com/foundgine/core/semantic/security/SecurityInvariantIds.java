...
/**
 * Port of {@code Foundgine.Core.Semantic.Security.SecurityInvariantIds}: canonical identifiers for
 * Foundgine security invariants.
 */
public final class SecurityInvariantIds {
    ...
    public static final String TRANSACTION_READ_COMMITTED_ISOLATION =
