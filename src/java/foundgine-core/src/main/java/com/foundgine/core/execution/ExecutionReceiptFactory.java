...
public final class ExecutionReceiptFactory {
    ...
    public static ExecutionReceipt create(
            ...
            Iterable<Integer> affectedNodeIds,
            Iterable<String> effects,
            Instant startedAt,
            Instant completedAt,
        ...
        if (evidence.authorizationFingerprint() == null) {
            throw new IllegalStateException(
                    "Execution evidence is missing an authorization fingerprint.");
        }
        ...
        return new ExecutionReceipt(
                ...
                startedAt,
                completedAt,
                distinctSortedNodeIds,
                distinctSortedEffects,
                resultFingerprint,
                approvalId,
                approvedBy,
                approvedAt,
    ...
    public static String fingerprintResult(ExecutionResult result) {
        ...
        if (result.pageInfo() != null) {
            ...
            canonical
                    .append("page[")
                    .append(page.startCursor())
                    .append('|')
                    .append(page.endCursor())
                    .append('|')
                    .append(page.hasNextPage())
                    .append('|')
                    .append(page.hasPreviousPage())
                    .append(']');
        }
    ...
    private static <T> List<T> distinctSorted(
            Iterable<T> values, java.util.Comparator<T> comparator) {
