...
/**
 * Host-owned source of the caller's security context for a single request. Transport adapters must
 * obtain this from trusted host authentication state, never from the untrusted request payload.
 */
@FunctionalInterface
