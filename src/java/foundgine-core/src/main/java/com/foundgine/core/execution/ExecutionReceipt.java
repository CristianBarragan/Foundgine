 ...
 *
 * <p>Immutable, provider-neutral evidence that a semantic execution
 * occurred. The receipt deliberately contains fingerprints rather than
 * request/result payloads so it can be persisted or transported without
 * copying domain data.
 */
