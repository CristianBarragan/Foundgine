...
public record SemanticPlanNode(int id, ExecutionOperation operation, EntityId entityId, List<FieldId> fields,
		RelationshipId viaRelationship, ConnectionId viaConnection, List<SemanticPlanNode> children,
		SemanticQueryOptions queryOptions, AuthorizationPredicate authorization,
		RelationshipCardinality relationshipCardinality, RelationshipTraversalMode traversalMode, int traversalOrder,
	...
	public SemanticPlanNode(int id, ExecutionOperation operation, EntityId entityId, List<FieldId> fields,
			RelationshipId viaRelationship, ConnectionId viaConnection, List<SemanticPlanNode> children) {
		this(id, operation, entityId, fields, viaRelationship, viaConnection, children, null, null, null,
