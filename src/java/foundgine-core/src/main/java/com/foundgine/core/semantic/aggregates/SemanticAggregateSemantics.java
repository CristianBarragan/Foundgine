...
public record SemanticAggregateSemantics(SemanticFilterAggregate aggregate,
                                          ...
                                          SemanticCardinalityRequirement cardinalityRequirement) {
    public SemanticAggregateSemantics {
        Objects.requireNonNull(aggregate); Objects.requireNonNull(emptyCollectionResult);
        Objects.requireNonNull(nullInputBehavior); Objects.requireNonNull(duplicateSensitivity);
        cardinalityRequirement = cardinalityRequirement == null ? SemanticCardinalityRequirement.NONE : cardinalityRequirement;
    }
    ...
    public boolean isDuplicateSensitive(){ return duplicateSensitivity == SemanticDuplicateSensitivity.SENSITIVE; }
    public boolean requiresCardinalityProof(){ return cardinalityRequirement == SemanticCardinalityRequirement.REQUIRES_PROOF; }
}
