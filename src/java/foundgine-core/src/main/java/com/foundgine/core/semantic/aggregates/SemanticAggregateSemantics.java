...
public record SemanticAggregateSemantics(
    ...
    public SemanticAggregateSemantics {
        ...
        cardinalityRequirement =
                cardinalityRequirement == null
                        ? SemanticCardinalityRequirement.NONE
                        : cardinalityRequirement;
    }

    public SemanticAggregateSemantics(
            SemanticFilterAggregate aggregate,
            SemanticEmptyCollectionResult empty,
            SemanticNullInputBehavior nulls,
            SemanticDuplicateSensitivity duplicates) {
