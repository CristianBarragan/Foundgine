...
public final class SecurityWarrantVerifier {
    ...
    public static void verify(
        ...
        if (w == null || keys == null) throw new NullPointerException();
        ...
        if (expectedIssuer == null)
            throw new IllegalStateException(
                    "Security warrant verification requires a configured expected issuer.");
    ...
    public static void verify(
            SecurityWarrant w, ISecurityWarrantKeyResolver k, Instant n, String issuer) {
