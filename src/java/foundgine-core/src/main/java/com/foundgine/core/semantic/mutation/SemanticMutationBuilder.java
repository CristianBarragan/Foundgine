...
public final class SemanticMutationBuilder {
    ...
    public static SemanticMutationOperation create(EntityId entity, List<SemanticMutationField> fields, List<FieldId> returnFields) {
        return operation(entity, SemanticMutationKind.CREATE, fields, null, List.of(), returnFields);
    }
    public static SemanticMutationOperation update(EntityId entity, List<SemanticMutationField> fields, SemanticFilterExpression filter, List<FieldId> returnFields) {
        return operation(entity, SemanticMutationKind.UPDATE, fields, filter, List.of(), returnFields);
    }
    public static SemanticMutationOperation delete(EntityId entity, SemanticFilterExpression filter, List<FieldId> returnFields) {
        return operation(entity, SemanticMutationKind.DELETE, List.of(), filter, List.of(), returnFields);
    }
    public static SemanticMutationOperation upsert(EntityId entity, List<SemanticMutationField> fields, List<FieldId> conflictFields, List<FieldId> returnFields) {
        return operation(entity, SemanticMutationKind.UPSERT, fields, null, conflictFields, returnFields);
    }
    private static SemanticMutationOperation operation(EntityId entity, SemanticMutationKind kind, List<SemanticMutationField> fields,
                                                       SemanticFilterExpression filter, List<FieldId> conflicts, List<FieldId> returns) {
        ...
        fs.forEach(f -> effects.add(new SemanticMutationEffect(SemanticMutationEffectKind.SET_FIELD, entity, f.field())));
