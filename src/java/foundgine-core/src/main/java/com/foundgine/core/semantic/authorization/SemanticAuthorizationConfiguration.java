...
public final class SemanticAuthorizationConfiguration {
    ...
    public interface FieldRule {
        boolean test(
                SemanticAuthorizationContext c, EntityId e, FieldId f, AuthorizationOperation o);
    }

    @FunctionalInterface
    public interface RelationshipRule {
        boolean test(
                SemanticAuthorizationContext c,
                EntityId e,
                RelationshipId r,
    ...
    public interface PredicateRule {
        AuthorizationPredicate apply(
                SemanticAuthorizationContext c, EntityId e, AuthorizationOperation o);
    }

    @FunctionalInterface
    public interface OperationRule {
        AuthorizationDecision apply(
                SemanticAuthorizationContext c,
                EntityId e,
                AuthorizationOperation o,
    ...
    public SemanticAuthorizationConfiguration allowAll() {
        return addEntityRule((c, e, o) -> true)
                .addFieldRule((c, e, f, o) -> true)
    ...
    AuthorizationPredicate getPredicate(
            SemanticAuthorizationContext c, EntityId e, AuthorizationOperation o) {
        AuthorizationPredicate result = null;
        for (var r : predicates) {
            var x = r.apply(c, e, o);
            if (x != null) result = result == null ? x : AuthorizationPredicate.and(result, x);
        }
        return result;
    }

    AuthorizationDecision getOperationDecision(
            SemanticAuthorizationContext c,
            EntityId e,
            AuthorizationOperation o,
            AuthorizationOperationName n) {
        ...
        for (var r : operations) {
            ...
            if (x != null) result = result == null ? x : AuthorizationDecision.combine(result, x);
        }
        return result;
    }
}
