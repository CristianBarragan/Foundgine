 ...
 *
 * <p>Validates the machine-readable security contract before a capability is
...
public final class SecurityInvariantContractValidator {
    ...
    public static List<String> validate(SemanticCapability capability) {
        ...
        if (!capability.relationships().isEmpty() && !invariants.contains(SecurityInvariantIds.RELATIONSHIP_VISIBILITY)) {
