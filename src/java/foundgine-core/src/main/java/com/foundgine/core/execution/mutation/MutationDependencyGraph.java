...
/**
 * Canonical provider-neutral execution dependency graph. Dependency edges are already resolved to
 * operation ordinals and physical target columns. Provider-specific correlation carriers are
 * introduced only during provider lowering.
 */
