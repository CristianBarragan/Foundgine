...
public final class MemorySecurityWarrantDelegationCompromiseStore
        implements ISecurityWarrantDelegationCompromiseStore {
    ...
    public SecurityWarrantDelegationCompromise compromise(
            SecurityWarrant r, Instant n, String i, String k) {
        ...
        var e =
                new SecurityWarrantDelegationCompromise(
                        r.id(), r.digest(), i, k, n, seq.incrementAndGet());
