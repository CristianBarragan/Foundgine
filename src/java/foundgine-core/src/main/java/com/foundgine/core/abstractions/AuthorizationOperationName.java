 ...
 *
 * <p>Optional named refinement of an {@link AuthorizationOperation} for
 ...
 * This is a policy-facing hint only: it never changes what {@link
 * AuthorizationOperation} means structurally, and it carries no storage or
 * provider semantics.
 */
