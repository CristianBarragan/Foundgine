 ...
 */
public record SemanticVersionSet(
        String semanticModelVersion,
        int capabilityContractVersion,
        int capabilityVersion,
        int intentVersion,
        int planVersion) {
    public static final int CURRENT_CAPABILITY_CONTRACT_VERSION = 1,
    ...
    public static SemanticVersionSet forModel(SemanticModel model) {
        ...
        return new SemanticVersionSet(
                "sha256:" + model.contractFingerprint(),
                CURRENT_CAPABILITY_CONTRACT_VERSION,
