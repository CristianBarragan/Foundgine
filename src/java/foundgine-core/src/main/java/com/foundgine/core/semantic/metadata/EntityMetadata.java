...
public record EntityMetadata(EntityId entityId, String name, List<ColumnMetadata> columns,
                             String storageName, List<FieldMetadata> fields, ColumnReference primaryKey,
                             Class<?> clrType, boolean event, ColumnReference temporalColumn,
