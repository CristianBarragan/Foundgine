 ...
 *
 * <p>Cancellation is observable both by polling and by registering a callback. The callback form is
 * required by physical providers that need to interrupt a blocking JDBC/HTTP operation rather than
...
public final class CancellationToken {
    ...
    /**
     * Registers a callback which is invoked when this token is cancelled. If cancellation has
     * already happened, the callback is invoked before the registration is returned. The returned
