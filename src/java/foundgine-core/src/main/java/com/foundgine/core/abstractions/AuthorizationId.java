...
/**
 * Port of {@code Foundgine.Core.Abstractions.AuthorizationId} (a C#
 * {@code readonly record struct}).
 *
 * <p>
 * Stable identifier for an AOT authorization predicate.
 *
 * <p>
...
public record AuthorizationId(long value) implements SemanticId {
	...
	public static final class Serializer extends StdSerializer<AuthorizationId> {
		...
		@Override
		public void serialize(AuthorizationId id, JsonGenerator generator, SerializerProvider provider)
				throws IOException {
