...
/**
 * Port of {@code Foundgine.Core.Abstractions.AuthorizationId} (a C# {@code readonly record
 * struct}).
 *
 ...
 */
@JsonSerialize(
        using = AuthorizationId.Serializer.class,
        keyUsing = AuthorizationId.KeySerializer.class)
@JsonDeserialize(
        using = AuthorizationId.Deserializer.class,
        keyUsing = AuthorizationId.KeyDeserializer.class)
public record AuthorizationId(long value) implements SemanticId {
    ...
    public static AuthorizationId create(String declaringType, String authorizationName) {
        return new AuthorizationId(
                SemanticIdentity.hash(
                        SemanticIdentity.authorizationKey(declaringType, authorizationName)));
    }
    ...
    public static final class Serializer extends StdSerializer<AuthorizationId> {
        ...
        public void serialize(
                AuthorizationId id, JsonGenerator generator, SerializerProvider provider)
                throws IOException {
    ...
    public static final class Deserializer extends StdDeserializer<AuthorizationId> {
        ...
        @Override
        public AuthorizationId deserialize(JsonParser parser, DeserializationContext context)
                throws IOException {
    ...
    public static final class KeySerializer
            extends com.fasterxml.jackson.databind.ser.std.StdSerializer<AuthorizationId> {
