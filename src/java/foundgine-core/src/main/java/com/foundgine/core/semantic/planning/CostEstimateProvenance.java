...
public record CostEstimateProvenance(
        String source,
        String statisticsVersion,
        Instant estimatedAtUtc,
        Duration statisticsAge,
    ...
    public static CostEstimateProvenance heuristic(String source, Instant estimatedAtUtc) {
        return new CostEstimateProvenance(
                source, null, estimatedAtUtc, null, CostStatisticsFreshness.UNKNOWN);
    }
    ...
    public static CostEstimateProvenance fromStatistics(
        ...
        CostStatisticsFreshness f =
                staleAfter == null
                        ? CostStatisticsFreshness.UNKNOWN
                        : age.compareTo(staleAfter.dividedBy(2)) <= 0
