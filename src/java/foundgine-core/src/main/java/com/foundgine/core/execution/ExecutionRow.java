 ...
 *
 * <p>One row returned by a provider. {@code values} retain their provider-facing names for
 * diagnostics/backwards compatibility, while {@code cells} provide stable provider-neutral
 * identities for result materialization.
 */
