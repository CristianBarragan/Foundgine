...
public final class SemanticContractProvider implements ISemanticContractProvider {
    ...
    public SemanticContractProvider(SemanticContractSnapshot contract) { this.contract=Objects.requireNonNull(contract); }
    @Override public SemanticContractSnapshot contract() { return contract; }
}
