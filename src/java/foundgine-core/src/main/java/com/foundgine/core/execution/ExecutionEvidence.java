 ...
 *
 * <p>Provider-neutral provenance for one execution. Evidence describes what was executed and which
 * authorization boundaries were present without retaining request objects, expression trees, or
