...
public abstract class ProviderPlan {
    ...
    public final String provider() { return provider; }
    public final SecurityInvariantProof securityProof() { return securityProof; }
    public final SemanticPlanAuthorizationBinding authorizationBinding() { return authorizationBinding; }

    void setSecurityProof(SecurityInvariantProof proof) { this.securityProof = proof; }
