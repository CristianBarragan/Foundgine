...
public interface IPlanRewriteRule {
    ...
    default double benefitEstimate() { return 0d; }
    default List<String> mustRunAfter() { return List.of(); }
    default List<String> mustRunBefore() { return List.of(); }
    default List<String> conflictsWith() { return List.of(); }
