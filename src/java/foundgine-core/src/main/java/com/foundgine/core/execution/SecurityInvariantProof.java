...
/**
 * Immutable security execution certificate bound to one exact provider plan and one exact Execution
 * IR fingerprint.
 */
public final class SecurityInvariantProof {
    ...
    static SecurityInvariantProof create(
            ProviderPlan plan,
            ExecutionIR ir,
        ...
        return new SecurityInvariantProof(
                plan, ExecutionIRFingerprint.create(ir), plan.provider(), r, p, m);
    }
