...
/**
 * Immutable security execution certificate bound to one exact provider plan and
 * one exact Execution IR fingerprint.
 */
public final class SecurityInvariantProof {
	...
	private SecurityInvariantProof(ProviderPlan boundPlan, String executionIrFingerprint, String provider,
	...
	public String executionIrFingerprint() {
		return executionIrFingerprint;
	}
	...
	static SecurityInvariantProof create(ProviderPlan plan, ExecutionIR ir, Collection<String> required,
