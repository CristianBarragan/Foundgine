 ...
 *
 * <p>Supports cancellation, scheduled cancellation, and live linked-token propagation. Providers
 * can register callbacks on the exposed token to interrupt blocking physical operations.
 */
public final class CancellationTokenSource implements AutoCloseable {
    ...
    /**
     * Port of {@code CancellationTokenSource.CreateLinkedTokenSource(CancellationToken)}. See class
     * caveat above.
     */
