 ...
 *
 * <p>
 * Supports cancellation, scheduled cancellation, and live linked-token
...
public final class CancellationTokenSource implements AutoCloseable {
	...
	/**
	 * Port of
	 * {@code CancellationTokenSource.CreateLinkedTokenSource(CancellationToken)}.
	 * See class caveat above.
	 */
