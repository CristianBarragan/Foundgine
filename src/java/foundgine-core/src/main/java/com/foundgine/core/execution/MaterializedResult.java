...
/**
 * Compatibility name for the semantic result tree. New code should consume {@link SemanticResult}
 * directly.
 *
 * <p>C# exposes an implicit conversion operator to {@code SemanticResult}; Java has no implicit
 * user-defined conversions, so {@link #toSemanticResult()} is the explicit equivalent callers must
 * invoke.
 */
@Deprecated
