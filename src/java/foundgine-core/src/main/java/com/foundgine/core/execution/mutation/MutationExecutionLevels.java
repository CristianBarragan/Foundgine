 ...
 *
 * <p>Provider-facing immutable dependency levels derived from the canonical execution dependency
 * graph.
 */
public record MutationExecutionLevels(List<List<Integer>> levels) {
    ...
    public static MutationExecutionLevels from(
        ...
        return new MutationExecutionLevels(
                MutationDependencyLevels.compute(operationCount, dependencies));
    }
