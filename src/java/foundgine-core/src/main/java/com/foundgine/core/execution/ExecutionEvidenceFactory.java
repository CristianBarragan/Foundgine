...
public final class ExecutionEvidenceFactory {
    ...
    public static ExecutionEvidence create(
        ...
        List<Integer> sortedNodeIds =
                StreamSupport.stream(authorizedNodeIds.spliterator(), false).sorted().toList();
    ...
    /**
     * Port of {@code ExecutionEvidenceFactory.Hash}: lowercase-hex SHA-256, matching {@code
     * Convert.ToHexString}'s uppercase form lowercased for Java's {@link HexFormat} default.
     */
