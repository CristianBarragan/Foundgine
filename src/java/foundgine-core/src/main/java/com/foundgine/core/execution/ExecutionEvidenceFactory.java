...
public final class ExecutionEvidenceFactory {
    ...
    public static ExecutionEvidence create(
            ...
            Iterable<Integer> authorizedNodeIds,
            int rowsReturned,
        ...
        List<Integer> sortedNodeIds = StreamSupport.stream(authorizedNodeIds.spliterator(), false)
                .sorted()
                .toList();
        ...
        return new ExecutionEvidence(
                ...
                rowsReturned,
                elapsedMilliseconds,
                providerOperation == null ? null : hash(providerOperation),
                null,
                null,
                null,
                null,
    ...
    /** Port of {@code ExecutionEvidenceFactory.Hash}: lowercase-hex SHA-256, matching {@code Convert.ToHexString}'s uppercase form lowercased for Java's {@link HexFormat} default. */
