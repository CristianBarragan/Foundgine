...
public record SemanticMutationOperation(EntityId entity, SemanticMutationKind kind, List<SemanticMutationField> fields,
		SemanticFilterExpression filter, List<FieldId> conflictFields, List<FieldId> returnFields,
