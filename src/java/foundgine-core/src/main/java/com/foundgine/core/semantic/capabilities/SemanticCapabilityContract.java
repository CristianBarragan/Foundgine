 ...
 *
 * <p>Canonical, machine-readable description of the semantic application surface. The contract is
 * descriptive and never replaces execution-time authorization.
 */
