...
@JsonSerialize(
        using = StorageEntityId.Serializer.class,
        keyUsing = StorageEntityId.KeySerializer.class)
@JsonDeserialize(
        using = StorageEntityId.Deserializer.class,
        keyUsing = StorageEntityId.KeyDeserializer.class)
public record StorageEntityId(long value) {
    ...
    public static final class Serializer extends StdSerializer<StorageEntityId> {
        ...
        @Override
        public void serialize(StorageEntityId id, JsonGenerator g, SerializerProvider p)
                throws IOException {
    ...
    public static final class Deserializer extends StdDeserializer<StorageEntityId> {
        ...
        @Override
        public StorageEntityId deserialize(JsonParser p, DeserializationContext c)
                throws IOException {
