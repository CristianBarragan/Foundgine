...
public record ModelId(long value) implements SemanticId {
    ...
    public static final class Serializer extends StdSerializer<ModelId> {
        ...
        @Override
        public void serialize(ModelId id, JsonGenerator generator, SerializerProvider provider)
                throws IOException {
    ...
    public static final class Deserializer extends StdDeserializer<ModelId> {
        ...
        @Override
        public ModelId deserialize(JsonParser parser, DeserializationContext context)
                throws IOException {
    ...
    public static final class KeySerializer
            extends com.fasterxml.jackson.databind.ser.std.StdSerializer<ModelId> {
