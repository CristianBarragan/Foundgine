...
public record ColumnId(long value) implements SemanticId {
    ...
    public static ColumnId create(String storageName, String columnName) {
        return new ColumnId(
                SemanticIdentity.hash(SemanticIdentity.columnKey(storageName, columnName)));
    }
    ...
    public static final class Serializer extends StdSerializer<ColumnId> {
        ...
        @Override
        public void serialize(ColumnId id, JsonGenerator generator, SerializerProvider provider)
                throws IOException {
    ...
    public static final class Deserializer extends StdDeserializer<ColumnId> {
        ...
        @Override
        public ColumnId deserialize(JsonParser parser, DeserializationContext context)
                throws IOException {
    ...
    public static final class KeySerializer
            extends com.fasterxml.jackson.databind.ser.std.StdSerializer<ColumnId> {
