...
public final class FoundgineProviderSecurityProfiles {
    ...
    public static ProviderSecurityConformanceProfile inMemory() {
        return new ProviderSecurityConformanceProfile(
                "in-memory",
                List.of(
                ...
                List.of(
                        "Suitable for semantic/query security testing; consequential PostgreSQL"
                                + " transaction guarantees are not inferred."));
    }
    ...
    public static ProviderSecurityConformanceProfile sql() {
        return new ProviderSecurityConformanceProfile(
                ...
                List.of(
                        ...
                        SecurityInvariantIds.PLAN_CACHE_CONTEXT_ISOLATION),
                List.of(
                        "Generic SQL preserves query-level guarantees; mutation guarantees require"
                                + " a provider-specific execution contract."));
    }
    ...
    public static ProviderSecurityConformanceProfile postgresTransferFunds() {
        return new ProviderSecurityConformanceProfile(
                ...
                List.of(
                        "High-assurance TransferFunds provider; transaction and concurrency"
                                + " guarantees are backed by PostgreSQL integration tests."));
    }
}
