...
public final class FoundgineProviderSecurityProfiles {
    ...
    public static ProviderSecurityConformanceProfile inMemory() {
        return new ProviderSecurityConformanceProfile("in-memory", List.of(
    ...
    public static ProviderSecurityConformanceProfile sql() {
        return new ProviderSecurityConformanceProfile("sql", List.of(
                SecurityInvariantIds.AUTHORIZATION_REQUIRED,
                SecurityInvariantIds.RUNTIME_AUTHORIZATION,
                SecurityInvariantIds.FIELD_VISIBILITY,
                SecurityInvariantIds.RELATIONSHIP_VISIBILITY,
    ...
    public static ProviderSecurityConformanceProfile postgresTransferFunds() {
        return new ProviderSecurityConformanceProfile("postgres-transfer-funds", List.of(
                SecurityInvariantIds.AUTHORIZATION_REQUIRED,
                SecurityInvariantIds.RUNTIME_AUTHORIZATION,
                SecurityInvariantIds.TENANT_ISOLATION,
                SecurityInvariantIds.PARAMETERIZED_VALUES,
