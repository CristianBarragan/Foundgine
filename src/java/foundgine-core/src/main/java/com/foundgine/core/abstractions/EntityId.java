...
/**
 * Port of {@code Foundgine.Core.Abstractions.EntityId} (a C# {@code readonly record struct}).
 *
 * <p>Stable identity of a semantic entity. The value is derived from the canonical semantic entity
 * name and is independent of declaration order, class metadata, or registration order.
 *
...
public record EntityId(long value) implements SemanticId {
    ...
    public static final class Serializer extends StdSerializer<EntityId> {
        ...
        @Override
        public void serialize(EntityId id, JsonGenerator generator, SerializerProvider provider)
                throws IOException {
    ...
    public static final class Deserializer extends StdDeserializer<EntityId> {
        ...
        @Override
        public EntityId deserialize(JsonParser parser, DeserializationContext context)
                throws IOException {
    ...
    public static final class KeySerializer
            extends com.fasterxml.jackson.databind.ser.std.StdSerializer<EntityId> {
