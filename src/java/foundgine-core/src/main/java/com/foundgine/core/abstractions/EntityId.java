 ...
 *
 * <p>Stable identity of a semantic entity. The value is derived from the canonical semantic entity name and is independent of declaration order, class metadata, or registration order.
 *
