...
public interface IMutationExecutionProvider {
     ...
     * default-interface-method overload; see {@link CancellationToken} for the caveat that Java's
     * cancellation model here is a placeholder.
     */
    default MutationResult execute(
