...
public interface IMutationExecutionProvider {
	...
	/**
	 * Cancellation-aware execution boundary. The default method mirrors the C#
	 * default-interface-method overload; see {@link CancellationToken} for the
	 * caveat that Java's cancellation model here is a placeholder.
	 */
	default MutationResult execute(ProviderMutationPlan plan, ExecutionContext context,
