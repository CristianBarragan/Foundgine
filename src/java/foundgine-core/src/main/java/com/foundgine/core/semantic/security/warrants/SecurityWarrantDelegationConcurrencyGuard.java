...
public final class SecurityWarrantDelegationConcurrencyGuard {
    ...
    public static SecurityWarrantDelegationConcurrencySnapshot capture(
            ISecurityWarrantDelegationConcurrencyStore s, SecurityWarrant p) {
        if (s == null || p == null) throw new NullPointerException();
        return s.capture(p);
    }

    public static SecurityWarrantDelegationReservation commitChild(
            ISecurityWarrantDelegationConcurrencyStore s,
            SecurityWarrant p,
            SecurityWarrant c,
            SecurityWarrantDelegationConcurrencySnapshot x) {
