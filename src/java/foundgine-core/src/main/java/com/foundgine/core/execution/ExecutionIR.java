 ...
 * </p>
 */
public record ExecutionIR(ExecutionIRNode root, List<String> requiredSecurityInvariants,
	...
	public static ExecutionIR from(SemanticPlan plan) {
		...
		return new ExecutionIR(ExecutionIRNode.from(plan.root()), plan.effectiveSecurityInvariants(),
