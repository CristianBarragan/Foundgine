...
public final class SemanticPlanOptimizer implements IPlanOptimizer {
    ...
    public SemanticPlanOptimizer(
        ...
        if (rules == null)
            rules =
                    List.of(
                            new AuthorizationCanonicalizationRule(),
                            new PredicatePushdownRule(),
                            new ProjectionPruningRule(),
                            new RelationshipTraversalOptimizationRule(),
                            new RelationshipJoinOrderingRule(),
                            new AggregateRelationshipFilterPushdownRule(),
    ...
    public SemanticPlanOptimizationResult optimize(SemanticPlan plan) {
        ...
        return new SemanticPlanOptimizationResult(
                ...
                SemanticPlanAuthorizationBindingProof.create(plan, composition.plan()),
    ...
    public static PlanRewriteRuleResult applyRule(
        ...
        return RewriteRuleComposer.applyRule(
