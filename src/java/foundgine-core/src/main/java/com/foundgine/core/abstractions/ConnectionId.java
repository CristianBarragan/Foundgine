...
/**
 * Port of {@code Foundgine.Core.Abstractions.ConnectionId} (a C# {@code readonly record struct}).
 *
 * <p>Stable identity of a semantic model connection.
 *
...
@JsonDeserialize(
        using = ConnectionId.Deserializer.class,
        keyUsing = ConnectionId.KeyDeserializer.class)
public record ConnectionId(long value) implements SemanticId {
    ...
    public static ConnectionId create(String semanticModelName, String semanticConnectionName) {
        return new ConnectionId(
                SemanticIdentity.hash(
                        SemanticIdentity.connectionKey(semanticModelName, semanticConnectionName)));
    }
    ...
    public static final class Deserializer extends StdDeserializer<ConnectionId> {
        ...
        @Override
        public ConnectionId deserialize(JsonParser parser, DeserializationContext context)
                throws IOException {
    ...
    public static final class KeySerializer
            extends com.fasterxml.jackson.databind.ser.std.StdSerializer<ConnectionId> {
