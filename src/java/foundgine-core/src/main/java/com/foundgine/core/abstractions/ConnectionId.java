...
public record ConnectionId(long value) implements SemanticId {
    ...
    public static ConnectionId create(String semanticModelName, String semanticConnectionName) {
        return new ConnectionId(SemanticIdentity.hash(SemanticIdentity.connectionKey(semanticModelName, semanticConnectionName)));
    }
    ...
    public static final class Serializer extends StdSerializer<ConnectionId> {
        ...
        @Override
        public void serialize(ConnectionId id, JsonGenerator generator, SerializerProvider provider) throws IOException {
