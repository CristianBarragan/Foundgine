...
public record RelationshipId(long value) implements SemanticId {
    ...
    public static RelationshipId create(String semanticEntityName, String semanticRelationshipName) {
        return new RelationshipId(SemanticIdentity.hash(SemanticIdentity.relationshipKey(semanticEntityName, semanticRelationshipName)));
    }
    ...
    public static final class Serializer extends StdSerializer<RelationshipId> {
        ...
        @Override
        public void serialize(RelationshipId id, JsonGenerator generator, SerializerProvider provider) throws IOException {
    ...
    public static final class KeySerializer extends com.fasterxml.jackson.databind.ser.std.StdSerializer<RelationshipId> {
