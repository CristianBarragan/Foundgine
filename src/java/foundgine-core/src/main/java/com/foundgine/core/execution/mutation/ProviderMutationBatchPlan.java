 ...
 *
 * <p>Opaque provider batch plan. Ordering, dependencies, and physical
 * representation belong to the provider-specific plan.
 *
 * <p>Ported as an {@code abstract class} rather than an abstract record for
 * the same reason as {@link ProviderMutationPlan}: Java records cannot be
 * extended, and a subtype should get equality over its own full shape, not
 * just this one field.
 */
