...
class AggregateRewriteParityTest {
    ...
    @Test void countExistenceRewritePreservesSemanticMeaning() {
    ...
    @Test void countEqualityZeroUsesEmptyShortCircuit() {
        var before = plan(new SemanticAggregateFilter(new RelationshipId(10), SemanticFilterAggregate.COUNT,
    ...
    @Test void unsupportedAggregateShapeIsNotRewritten() {
        var before = plan(new SemanticAggregateFilter(new RelationshipId(10), SemanticFilterAggregate.COUNT,
