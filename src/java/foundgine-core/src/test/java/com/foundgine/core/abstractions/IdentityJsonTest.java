...
class IdentityJsonTest {
	...
	void allIdentityTypesSerializeAsNumericValuesAndRoundTrip(long value) throws Exception {
		Object[] values = { new EntityId(value), new FieldId(value), new RelationshipId(value), new ColumnId(value),
				new ModelId(value), new ConnectionId(value), new AuthorizationId(value) };
	...
	void dictionaryKeyedByRelationshipIdSupports64BitValues() throws Exception {
		...
		Map<RelationshipId, String> result = mapper.readValue(json,
				mapper.getTypeFactory().constructMapType(Map.class, RelationshipId.class, String.class));
