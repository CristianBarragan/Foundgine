...
class ProviderSecurityConformanceMatrixParityTest {
    private static final List<String> QUERY_REQUIREMENTS =
            List.of(
    ...
    private static final List<String> TRANSFER_REQUIREMENTS =
            List.of(
    ...
    void unknownProviderFailsClosed() {
        ...
        assertThrows(
                ...
                () -> matrix.evaluate("unknown", QUERY_REQUIREMENTS));
    }

    @Test
    void providerCannotRegisterUnknownInvariant() {
        var profile =
                new ProviderSecurityConformanceProfile(
                        "hostile-provider", List.of("security.fake"), List.of());
        assertThrows(
                ...
                new ProviderSecurityConformanceMatrix()
                        .register(
                                new ProviderSecurityConformanceProfile(
                                        ...
                                        List.of(
                                                "hostile provider claims it preserves authorization"
                                                        + " only")));
        var proof =
                matrix.evaluate(
                        "hostile-provider",
