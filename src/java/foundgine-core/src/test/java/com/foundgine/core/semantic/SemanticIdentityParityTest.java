...
class SemanticIdentityParityTest {
	...
	void identityNamespacesAreDeterministicAndDistinct() {
		...
		assertEquals(SemanticIdentity.relationshipKey("Customer", "Accounts"),
	...
	void explicitZeroIdentityIsRejected() {
		var ex = assertThrows(IllegalArgumentException.class, () -> SemanticIdentity.validateExplicitId(0L, "field"));
