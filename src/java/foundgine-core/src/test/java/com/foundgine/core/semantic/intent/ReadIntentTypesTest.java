...
class ReadIntentTypesTest {
    @Test
    void selectionsAndFiltersAreImmutable() {
        ...
        var intent =
                new ReadIntent(
                        "Order",
                        selections,
                        new ReadFieldFilter("id", SemanticFilterOperator.EQ, "1"),
                        List.of(),
                        10,
                        0,
                        null,
    ...
    @Test
    void intentDocumentRejectsWrongVersion() {
        var document =
                new SemanticIntentDocument("fingerprint", new ReadIntent("Order", List.of()), 99);
