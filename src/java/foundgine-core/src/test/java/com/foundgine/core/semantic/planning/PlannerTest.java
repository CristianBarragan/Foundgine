...
class PlannerTest {
    ...
    void rootBecomesScanAndChildrenBecomeTraversal() {
        ...
        var root =
                new SemanticReadNode(
                        1, customer, List.of(f), null, null, List.of(child), null, null);
    ...
    void rejectsNonRootWithoutParentEdge() {
        var n =
                new SemanticReadNode(
                        1, new EntityId(1), List.of(), null, null, List.of(), null, null);
        assertThrows(
    ...
    void rejectsNodeWithBothRelationshipAndConnection() {
        var n =
                new SemanticReadNode(
                        ...
                        null);
        assertThrows(
                IllegalArgumentException.class, () -> new Planner().plan(new SemanticOperation(n)));
    }
    ...
    void detectsDuplicateNodeIds() {
        ...
        var root =
                new SemanticReadNode(
                        1, new EntityId(1), List.of(), null, null, List.of(a, b), null, null);
        assertThrows(
                IllegalArgumentException.class,
                () -> new Planner().plan(new SemanticOperation(root)));
    }
}
