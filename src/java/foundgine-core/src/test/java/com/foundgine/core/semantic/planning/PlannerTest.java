...
class PlannerTest {
 @Test void rootBecomesScanAndChildrenBecomeTraversal(){
  var customer=new EntityId(1); var order=new EntityId(2); var f=new FieldId(11); var r=new RelationshipId(21);
 ...
 @Test void rejectsNonRootWithoutParentEdge(){
 ...
 @Test void rejectsNodeWithBothRelationshipAndConnection(){
  var n=new SemanticReadNode(1,new EntityId(1),List.of(),new RelationshipId(1),new ConnectionId(2),List.of(),null,null);
  assertThrows(IllegalArgumentException.class,()->new Planner().plan(new SemanticOperation(n)));
 }
 @Test void detectsDuplicateNodeIds(){
