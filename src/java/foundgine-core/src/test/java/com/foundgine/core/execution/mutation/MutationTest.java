...
class MutationTest {
    ...
    void totalAffectedRowsSumsAllResults() {
        MutationBatchResult batch =
                new MutationBatchResult(
                        List.of(
                                new MutationResult(2),
                                new MutationResult(3),
                                new MutationResult(0)));
    ...
    void childrenAreGroupedByRelationship() {
        MutationMaterializedNode parent =
                new MutationMaterializedNode(0, EntityId.create("Order"), Map.of());
        RelationshipId lineItems = RelationshipId.create("Order", "LineItems");

        MutationMaterializedNode child =
                new MutationMaterializedNode(1, EntityId.create("LineItem"), Map.of());
