...
class RewriteRuleComposerParityTest {
    ...
    @Test void composerAppliesDeterministicRewriteAndStops() {
    ...
    @Test void composerRejectsInvalidApplicationBudget() {
        assertThrows(IllegalArgumentException.class,
                () -> new RewriteRuleComposer(List.of(new ProjectionPruningRule()),
                        new RewriteRuleCompositionOptions(0, 1)));
    }

    @Test void composerHonorsPlanVisitBudget() {
        assertThrows(IllegalArgumentException.class,
                () -> new RewriteRuleComposer(List.of(new ProjectionPruningRule()),
