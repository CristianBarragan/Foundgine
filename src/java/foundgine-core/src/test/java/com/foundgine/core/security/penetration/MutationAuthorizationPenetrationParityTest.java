...
/**
 * Hostile mutation-plan parity tests: unauthorized fields, filters, and batch operations fail
 * closed.
 */
class MutationAuthorizationPenetrationParityTest {
    ...
    void unauthorizedWriteFieldIsRejected() {
                ...
                new MutationPlan(
                        List.of(
                                new MutationOperation(
                                        ...
                                        MutationKind.UPDATE,
                                        List.of(
                                                new MutationFieldValue(
                                                        new ColumnId(12), "attacker")),
                                        null)));
        ...
        var exception =
                assertThrows(
                        ...
                        () ->
                                new MutationAuthorizer(
                                                schema, new AllowOnlyFieldPolicy(new FieldId(1)))
                                        .authorize(plan));
    ...
    void unauthorizedReturnFieldIsRejected() {
        ...
        assertThrows(
                SemanticAuthorizationException.class,
                () ->
                        new MutationAuthorizer(schema, new AllowOnlyFieldPolicy(new FieldId(1)))
                                .authorize(plan));
    }
                ...
                new SemanticMutationOperationGraph(
                        List.of(
                                SemanticMutationBuilder.update(
                                        entity.id(),
                                        List.of(new SemanticMutationField(new FieldId(1), "ok")),
                                        null,
                                        null),
                                SemanticMutationBuilder.update(
                                        entity.id(),
    ...
    @SafeVarargs
    private static MutationEntitySchema entity(
            int id, String name, Map.Entry<Integer, Integer>... fields) {
