...
class SemanticMutationIntentBuilderParityTest {
    ...
    void openMutationBuilderSupportsGeneratedValueDependenciesWithoutProviderConcepts() {
        var graph =
                new SemanticMutationIntentBuilder(buildModel())
    ...
    void openMutationBuilderPreservesUpdateFiltersAndConflictSemantics() {
        ...
        assertInstanceOf(
                com.foundgine.core.semantic.query.SemanticFieldFilter.class,
    ...
    private static SemanticModel buildModel() {
        return new SemanticModelBuilder()
                .entity(
                        CUSTOMER,
                        "Customer",
                        e -> e.identity(ID, "Id").field(NAME, "Name", String.class))
                .entity(
                        ACCOUNT,
                        "Account",
                        e ->
                                e.identity(new FieldId(5), "Id")
                                        .field(CUSTOMER_ID, "CustomerId", Long.class)
