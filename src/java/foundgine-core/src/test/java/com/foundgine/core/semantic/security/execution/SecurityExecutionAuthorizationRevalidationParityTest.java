...
class SecurityExecutionAuthorizationRevalidationParityTest {
    private static SemanticContractSnapshot contract() {
        return new com.foundgine.core.semantic.SemanticModelBuilder()
                .entity(
                        com.foundgine.core.abstractions.EntityId.create("Customer"),
                        "Customer",
                        e ->
                                e.identity(
                                        com.foundgine.core.abstractions.FieldId.create(
                                                "Customer", "Id"),
                                        "Id"))
                .build()
                .freeze()
    ...
    void revokedAuthorityFailsClosed() {
        ...
        var evidence =
                new SemanticAuthorizationEvidence(
                        contract.contractFingerprint(), "a", 4L, "authority");
