...
/**
 * Port of {@code
 * Foundgine.Core.Semantic.Tests.Security.Warrants.SecurityWarrantDelegationTrustSecurityTests}.
 */
class SecurityWarrantDelegationTrustParityTest {

    private static ISecurityWarrantDelegationTrustResolver resolver(
            DelegationIssuerTrust... trusts) {
        return issuer ->
                Arrays.stream(trusts)
                        .filter(x -> x.issuer().equals(issuer))
                        .findFirst()
                        .orElse(null);
    }
    ...
    private static SecurityWarrant create(
            String id, String issuer, String subject, String keyId, Instant now) {
        ...
        assertThrows(
                ...
                () ->
                        SecurityWarrantDelegationTrust.verifyIssuer(
                                parent, child, trust, now, "tenant-a"));
    }
    ...
    void unknownIssuerIsRejected() {
        ...
        assertThrows(
                ...
                () ->
                        SecurityWarrantDelegationTrust.verifyIssuer(
                                parent, child, resolver(), now, "tenant-a"));
    }
    ...
    void audienceScopeIsEnforced() {
        ...
        assertThrows(
                ...
                () ->
                        SecurityWarrantDelegationTrust.verifyIssuer(
                                parent, withOtherAudience, trust, now, null));
    }
    ...
    void issuerMustBeParentSubject() {
        ...
        assertThrows(
                ...
                () ->
                        SecurityWarrantDelegationTrust.verifyIssuer(
                                parent, withOtherIssuer, trust, now, null));
    }
}
