...
class SemanticMutationTest {
    private static SemanticModel model() {
        ...
        var entity =
                new SemanticEntity(
                        customer,
                        "Customer",
                        new SemanticFieldIdentity(id, "Id"),
                        List.of(
                                new SemanticField(id, "Id", Long.class),
                                new SemanticField(name, "Name", String.class)),
                        List.of());
    ...
    void aggregateLegalityRejectsCountToMin() {
        var r =
                com.foundgine.core.semantic.aggregates.AggregateRewriteLegality.checkSubstitution(
