...
class AggregateRelationshipFilterPushdownParityTest {
	@Test
	void someRelationshipPredicateIsPushedIntoCount() {
		var relationship = new RelationshipId(7);
		var childPredicate = new SemanticAggregateFilter(new RelationshipId(99), SemanticFilterAggregate.COUNT, null,
				SemanticAggregateFilterOperator.GT, 0);
		var count = new SemanticAggregateFilter(relationship, SemanticFilterAggregate.COUNT, null,
				SemanticAggregateFilterOperator.GT, 0);
		...
		var node = new SemanticPlanNode(1, ExecutionOperation.SCAN, new EntityId(1), List.of(), null, null, List.of(),
				new SemanticQueryOptions(filter, List.of(), null, null, null), null, null, null, -1, null);
	...
	@Test
	void unrelatedRelationshipDoesNotRewrite() {
		var count = new SemanticAggregateFilter(new RelationshipId(7), SemanticFilterAggregate.COUNT, null,
				SemanticAggregateFilterOperator.GT, 0);
		var some = new SemanticRelationshipFilter(new RelationshipId(8), SemanticRelationshipQuantifier.SOME,
				new SemanticAggregateFilter(new RelationshipId(99), SemanticFilterAggregate.COUNT, null,
						SemanticAggregateFilterOperator.GT, 0));
		var node = new SemanticPlanNode(1, ExecutionOperation.SCAN, new EntityId(1), List.of(), null, null, List.of(),
				new SemanticQueryOptions(new SemanticAndFilter(List.of(count, some)), List.of(), null, null, null),
