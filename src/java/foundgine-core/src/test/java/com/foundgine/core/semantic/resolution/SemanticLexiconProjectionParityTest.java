...
class SemanticLexiconProjectionParityTest {
    ...
    void buildProjectsEntityAsEntityAndNodeWithAliases() {
        ...
        var entityEntry = single(entries, x ->
                x.kind() == SemanticLexicalCandidateKind.ENTITY && x.canonicalName().equals("Customer"));
        ...
        var nodeEntry = single(entries, x ->
                x.kind() == SemanticLexicalCandidateKind.NODE && x.canonicalName().equals("Customer"));
    ...
    void buildProjectsFieldWithOwningEntityNameAndAliases() {
        ...
        var contract = new SemanticModelBuilder()
                .entity(customer, "Customer", e -> e
                        .identity(new FieldId(1), "Id")
                        .field(nameField, "Name", String.class)
    ...
    void buildProjectsLogicalTraversalWithEndpointNames() {
        ...
        var contract = new SemanticModelBuilder()
                ...
                .entity(order, "Order", e -> e
                        ...
                        .relationship(new RelationshipId(2), "Lines", line, RelationshipCardinality.MANY))
    ...
    private static SemanticLexiconEntry single(
            List<SemanticLexiconEntry> entries,
