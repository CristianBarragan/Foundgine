...
class SecurityWarrantDelegationStateMachineParityTest {
    ...
    void revokedWarrantCannotDelegate() {
        ...
        assertEquals(
                SecurityWarrantDelegationStateMachine.State.REVOKED, transition.after().state());
    ...
    void compromisedWarrantCannotReturnToActiveThroughKeyRotation() {
        ...
        assertEquals(
                SecurityWarrantDelegationStateMachine.State.COMPROMISED, machine.read(w).state());
    }
    ...
    void keyRotationAdvancesSequenceWithoutChangingAuthorityState() {
        ...
        assertEquals(
                SecurityWarrantDelegationStateMachine.State.ACTIVE, transition.after().state());
