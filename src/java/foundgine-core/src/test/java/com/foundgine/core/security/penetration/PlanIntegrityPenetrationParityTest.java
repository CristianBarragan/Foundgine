...
class PlanIntegrityPenetrationParityTest {
    private static ExecutionIR ir(String... invariants) {
        ...
        return new ExecutionIR(
                node,
                List.of(invariants),
                new SemanticPlanAuthorizationBinding("contract", "auth"));
    }
        ...
        assertThrows(
                ...
                () ->
                        SecurityInvariantExecutionGate.ensureExecutable(
                                new Plan("p"), ir(SecurityInvariantIds.AUTHORIZATION_REQUIRED)));
    }
        ...
        assertThrows(
                ...
                () ->
                        SecurityInvariantProofGate.attachAndValidate(
                                new Plan("weak"),
                                ir(SecurityInvariantIds.TENANT_ISOLATION),
                                new DeclarationOnly()));
    }
    ...
    void unknownInvariantCannotCrossCertificationBoundary() {
        assertThrows(
                ...
                () ->
                        SecurityInvariantProofGate.attachAndValidate(
                                new Plan("p"), ir("pentest.unknown-invariant"), new Good()));
    }
}
