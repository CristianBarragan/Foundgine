...
class SemanticEquivalenceProofParityTest {
    ...
    void authorizationOperandReorderingIsSemanticallyEquivalent() {
        var a = AuthorizationPredicate.equal(
            AuthorizationPredicate.resourceParameter("a"), AuthorizationPredicate.constant("1"));
        var b = AuthorizationPredicate.equal(
            AuthorizationPredicate.resourceParameter("b"), AuthorizationPredicate.constant("2"));
    ...
    private static SemanticPlanNode node(List<FieldId> fields, AuthorizationPredicate authorization,
        ...
        return new SemanticPlanNode(1, ExecutionOperation.SCAN, new EntityId(1),
            fields, null, null, List.of(), options, authorization,
