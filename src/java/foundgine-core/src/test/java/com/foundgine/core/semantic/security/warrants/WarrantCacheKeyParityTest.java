 ...
 * .Different_warrants_cannot_share_an_authority_cache_key}: two warrants that differ only by
 * id/nonce must digest differently, so an authority-bearing provider-plan cache keyed by warrant
 * digest cannot be confused between them.
 */
