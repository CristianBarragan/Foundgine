...
class SecurityResourceLimitParityTest {
                ...
                new SemanticRequest(
                        ...
                        List.of(
                                new SemanticSelection(
                                        ID,
                                        null,
                                        List.of(new SemanticSelection(ID, null, List.of())))),
                        null,
                        null);
    ...
    void orderPathDepthIsBounded() {
        var order =
                new SemanticOrderTerm(ID, SemanticSortDirection.ASC, List.of(ORDERS, ORDERS), null);
        var request =
                new SemanticRequest(
                        CUSTOMER,
                        List.of(new SemanticSelection(ID, null, List.of())),
    ...
    private static SecurityResourceLimits limits(
            int selectionDepth,
            int graphNodes,
            int graphDepth,
            int graphEdges,
