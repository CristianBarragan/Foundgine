 ...
 *
 * <p>The Java API uses {@code forAggregate}/{@code tryGet} because {@code for} is a Java keyword.
 * The behavioral contract is otherwise identical: the catalog is closed over the registered
 * aggregates and unknown lookups fail closed.
 */
class SemanticAggregateSemanticsParityTest {
    ...
    void catalogExposesEveryRegisteredAggregate() {
        var aggregates =
                SemanticAggregateSemanticsCatalog.ALL.stream()
