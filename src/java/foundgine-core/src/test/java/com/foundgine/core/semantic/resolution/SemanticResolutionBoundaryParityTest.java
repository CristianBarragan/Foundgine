    ...
    void emptySelectionSetIsRejected() {
        var ex =
                assertThrows(
                        ...
                        () ->
                                new SemanticRequestResolver(customerContract())
                                        .resolve(
                                                new SemanticRequest(
                                                        new EntityId(1), List.of(), null, null)));
    ...
    void repeatedRelationshipSelectionIsRejectedBeforeGraphConstruction() {
        ...
        var request =
                new SemanticRequest(
                        customer,
                        List.of(
                                new SemanticSelection(null, rel, List.of(child)),
                                new SemanticSelection(null, rel, List.of(child))),
                        null,
                        null);
        var ex =
        ...
        var graph =
                new SemanticRequestResolver(new SemanticContractSnapshot(model.freeze()))
                        .resolve(
                                new SemanticRequest(
                                        customer,
                                        List.of(new SemanticSelection(name, null, List.of())),
                                        null,
                                        null));
