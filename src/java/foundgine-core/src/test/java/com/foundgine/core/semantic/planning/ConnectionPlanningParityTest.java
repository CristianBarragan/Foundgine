...
class ConnectionPlanningParityTest {
    ...
    void connectionIsPreservedAsDistinctTraversalOperation() {
        ...
        graph.addConnection(
                new EntityId(20), new ConnectionId(30), root, List.of(new FieldId(2)), null);
        ...
        var predicate =
                AuthorizationPredicate.equal(
                        AuthorizationPredicate.member(
                                AuthorizationPredicate.parameter("user"), "TenantId"),
                        AuthorizationPredicate.member(
                                AuthorizationPredicate.parameter("contract"), "TenantId"));
