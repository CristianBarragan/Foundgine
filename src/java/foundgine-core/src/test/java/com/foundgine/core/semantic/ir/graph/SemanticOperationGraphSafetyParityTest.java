...
class SemanticOperationGraphSafetyParityTest {
    ...
    void rejectsExcessiveDepth() {
        var leaf =
                new SemanticReadNode(
                        5,
                        new EntityId(5),
                        List.of(new FieldId(34)),
                        new RelationshipId(24),
                        null,
                        List.of(),
                        null,
                        null);
        var n4 =
                new SemanticReadNode(
                        4,
                        new EntityId(4),
                        List.of(new FieldId(33)),
                        new RelationshipId(23),
                        null,
                        List.of(leaf),
                        null,
                        null);
        var n3 =
                new SemanticReadNode(
                        3,
                        new EntityId(3),
                        List.of(new FieldId(32)),
                        new RelationshipId(22),
                        null,
                        List.of(n4),
                        null,
                        null);
        var n2 =
                new SemanticReadNode(
                        2,
                        new EntityId(2),
                        List.of(new FieldId(31)),
                        new RelationshipId(21),
                        null,
                        List.of(n3),
                        null,
                        null);
        ...
        var ex =
                assertThrows(
                        ...
                        () ->
                                SemanticOperationGraphSafetyValidator.validate(
                                        graph,
                                        new SecurityResourceLimits(
                                                32, 256, 3, 255, 512, 256, 32, 256, 64, 16, 1000,
                                                1_000_000, 4096, 128, 64, 64, 256, 256)));
    ...
    void rejectsExcessiveNodes() {
        ...
        var limits =
                new SecurityResourceLimits(
                        32, 2, 32, 255, 512, 256, 32, 256, 64, 16, 1000, 1_000_000, 4096, 128, 64,
                        64, 256, 256);
        assertThrows(
                IllegalStateException.class,
    ...
    void acceptsBoundedGraph() {
        ...
        var limits =
                new SecurityResourceLimits(
                        32, 2, 2, 1, 2, 256, 32, 256, 64, 16, 1000, 1_000_000, 4096, 128, 64, 64,
                        256, 256);
