...
class OpenIntentTraversalParityTest {
    static final EntityId CUSTOMER = new EntityId(1),
            CUSTOMER_REL = new EntityId(2),
            CONTRACT = new EntityId(3),
    ...
    static final RelationshipId CUSTOMER_RELATIONSHIPS = new RelationshipId(10),
            RELATIONSHIP_CONTRACT = new RelationshipId(11),
            CONTRACT_TRANSACTIONS = new RelationshipId(12);
                ...
                new ReadIntent(
                        ...
                        List.of(
                                new ReadSelection(
                                        null,
                                        "transactions",
                                        List.of(new ReadSelection("Amount")))));
        ...
        var typed =
                SemanticOperationGraph.create(
                        SemanticOperationCompiler.compile(
                                new SemanticRequestResolver(snapshot)
                                        .resolve(compiler.compile(intent))));
        assertEquals(
                SemanticOperationGraphFingerprint.create(typed),
    ...
    void dynamicLogicalTraversalPreservesAuthorizationAtEveryHop() {
        ...
        var graph =
                new SemanticRequestResolver(snapshot)
                        .resolve(new ReadIntentCompiler(snapshot).compile(intent));
    ...
    private static SemanticModel buildModel() {
        return new SemanticModelBuilder()
                ...
                .entity(
                        ...
                        "Transaction",
                        e ->
                                e.identity(new FieldId(5), "Id")
                                        .field(AMOUNT, "Amount", BigDecimal.class))
                .traversal(
                        CUSTOMER,
                        "transactions",
                        CUSTOMER_RELATIONSHIPS,
