...
class PlanRewriteRuleTest {
    ...
    @Test
    void countGreaterThanZeroUsesExistsShortCircuit() {
        var before =
                plan(
        ...
        assertEquals(
                ...
                after.root().aggregateExecutionStrategy());
        assertEquals(
    ...
    @Test
    void countEqualZeroUsesEmptyShortCircuit() {
        var before =
                plan(
                        new SemanticAggregateFilter(
                                new RelationshipId(10),
    ...
    @Test
    void countGreaterThanOneIsNotReduced() {
        var before =
                plan(
                        new SemanticAggregateFilter(
                                new RelationshipId(10),
    ...
    @Test
    void traversalOptimizationUsesRelationshipCardinality() {
        var child =
                new SemanticPlanNode(
                        2,
        ...
        assertEquals(
                ...
                after.root().children().get(0).traversalMode());
        assertTrue(SemanticEquivalenceProof.create(before, after).isSatisfied());
    }

    @Test
    void projectionPruningRemovesOnlyDuplicates() {
        ...
        var before =
                new SemanticPlan(
                        new SemanticPlanNode(
                                ...
                                ExecutionOperation.SCAN,
                                new EntityId(1),
                                List.of(field, new FieldId(4), field),
                                null,
                                null,
                                List.of()));
    ...
    @Test
    void authorizationCanonicalizationIsIdempotent() {
        ...
        assertEquals(
                SemanticEquivalenceFingerprint.create(before),
                SemanticEquivalenceFingerprint.create(once));
    }
}
