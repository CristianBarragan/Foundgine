...
/**
 * Port of {@code Foundgine.Core.Semantic.Tests.SemanticVersioningTests} (declared alongside {@code
 * SemanticCapabilityContractTests} in the C# source file).
 */
                        ...
                        .entity(
                                ...
                                e ->
                                        e.identity(new FieldId(1), "Id")
                                                .field(new FieldId(1), "Name", String.class));
            ...
            builder.entity(
                    ...
                    e ->
                            e.identity(new FieldId(2), "Id")
                                    .field(new FieldId(2), "Number", String.class));
        }
