...
class ExecutionMutationIRParityE2ETest {
        ...
        var entity =
                new MutationEntitySchema(
                        ...
                        Map.of(
                                ...
                                ColumnId.create("customers", "name")),
                ...
                new MutationOperation(
                        ...
                        List.of(
                                new MutationFieldValue(
                                        ColumnId.create("customers", "name"), "Alice")),
                        null,
                        null,
                        List.of(FieldId.create("Customer", "Name")));
        var ir =
                ExecutionMutationIR.ExecutionMutationIRCompiler.compile(
                        new MutationBatchPlan(List.of(op), List.of()));
    ...
    void forwardDependencyIsRejectedAtExecutionBoundary() {
        ...
        var op =
                new MutationOperation(
                        entity, MutationKind.DELETE, List.of(), null, null, List.of());
        var dependency =
                new MutationDependency(
                        0, 0, FieldId.create("Customer", "Id"), ColumnId.create("customers", "id"));
        assertThrows(
                IllegalStateException.class,
                () ->
                        ExecutionMutationIR.ExecutionMutationIRCompiler.compile(
                                new MutationBatchPlan(List.of(op), List.of(dependency))));
    }
}
