...
class SemanticRequestResolverParityTest {
	...
	void requestResolvesToCustomerAccountTransactionGraph() {
		...
		var model = new SemanticModelBuilder()
				...
				.build();
		var txSelections = List.of(new SemanticSelection(new FieldId(1), null, List.of()),
				new SemanticSelection(new FieldId(3), null, List.of()));
		var accountSelections = List.of(new SemanticSelection(new FieldId(1), null, List.of()),
	...
	void requestCannotSelectUnknownRelationship() {
		...
		var request = new SemanticRequest(customer,
				List.of(new SemanticSelection(null, new RelationshipId(99), List.of())), null, null);
