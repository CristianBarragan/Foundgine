...
class ProviderExecutableConformanceParityTest {
    ...
    void certificationResultRequiresEveryRequiredInvariant() {
        var result =
                new ProviderSecurityConformanceResult(
                        "test",
                        List.of(
                ...
                assertThrows(
                        ...
                        () ->
                                SecurityInvariantProofGate.attachAndValidate(
                                        compiler.compile(ir), ir, compiler));
        assertTrue(
                exception
                        .getMessage()
                        .toLowerCase()
                        .contains("no concrete security conformance evaluator"));
    }
    ...
    void certificateCannotBeReplayedAgainstDifferentExecutionIr() {
        ...
        var exception =
                assertThrows(
                        IllegalStateException.class,
                        () ->
                                SecurityInvariantExecutionGate.ensureExecutable(
                                        certified, differentIr));
        assertTrue(
                exception
                        .getMessage()
                        .toLowerCase()
                        .contains("exact provider plan and execution ir"));
    }
    ...
    private static ExecutionIR testIr(String invariant) {
        var node =
                new ExecutionIRNode(
                        ...
                        new com.foundgine.core.abstractions.EntityId(1),
                        List.of(),
                        null,
                        null,
                        List.of(),
        ...
        return new ExecutionIR(
                node,
                List.of(invariant),
                new com.foundgine.core.semantic.planning.SemanticPlanAuthorizationBinding(
    ...
    private static final class HostileCertifiedCompiler
    ...
    private static final class HonestCompiler
            implements IProviderPlanCompiler,
                    ISecurityInvariantProviderCompiler,
                    IProviderSecurityConformanceEvaluator {
        @Override
