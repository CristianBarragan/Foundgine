    ...
    void relationshipIdentityIsStableWhenDerivedFromNames() {
        ...
        var model =
                new SemanticModelBuilder()
                        ...
                        .build();
        assertEquals(
                RelationshipId.create("Customer", "Orders"),
                model.get(customer).relationships().get(0).id());
    }
                        ...
                        .entity(
                                ...
                                e ->
                                        e.identity(new FieldId(1), "Id")
                                                ...
                                                .constraint(
                                                        name, SemanticConstraint.pattern("^[A-Z]"))
                                                .constraint(
                                                        credit,
    ...
    void looseValidationAllowsMultipleRoots() {
        var model =
                new SemanticModelBuilder()
                        ...
                        .entity(new EntityId(2), "Order", e -> e.identity(new FieldId(2), "Id"))
                        .build();
        ...
        assertThrows(
                IllegalStateException.class, () -> SemanticGraphValidator.validate(graph, model));
    }
}
