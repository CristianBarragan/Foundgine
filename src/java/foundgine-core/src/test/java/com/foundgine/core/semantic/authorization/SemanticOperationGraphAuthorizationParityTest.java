...
class SemanticOperationGraphAuthorizationParityTest {
    ...
    void graphAuthorizationReturnsOnlyAuthorizedSubgraph() {
        var contract = model();
        var authorized =
                new SemanticAuthorizer(new DenyTransactionsPolicy())
                        .authorize(contract, SemanticOperationGraph.create(operation()));
        assertEquals(1, authorized.nodes().size());
        assertTrue(
                authorized.nodes().stream()
                        .noneMatch(n -> n.entityId().equals(EntityId.create("Transaction"))));
    ...
    void graphAuthorizationEvidenceIsBoundToContract() {
        ...
        var result =
                new SemanticAuthorizer(new AllowAllSemanticAuthorizationPolicy())
                        .authorizeGraphWithEvidence(
                                contract, SemanticOperationGraph.create(operation()));
        ...
        return new SemanticContractSnapshot(
                new SemanticModelBuilder()
                        .entity(
                                ...
                                "Customer",
                                e ->
                                        e.identity(FieldId.create("Customer", "Id"), "Id")
                                                .field(
                                                        FieldId.create("Customer", "Id"),
                                                        "Id",
                                                        Long.class)
                                                .relationship(
                                                        rel,
                        ...
                        .entity(
                                ...
                                "Transaction",
                                e ->
                                        e.identity(FieldId.create("Transaction", "Id"), "Id")
                                                .field(
                                                        FieldId.create("Transaction", "Id"),
                                                        "Id",
                                                        Long.class))
                        .build()
                        .freeze());
    ...
    private static SemanticOperation operation() {
        var transaction =
                new SemanticReadNode(
                        ...
                        List.of(FieldId.create("Transaction", "Id")),
        ...
        var customer =
                new SemanticReadNode(
                        ...
                        List.of(FieldId.create("Customer", "Id")),
                        null,
                        null,
                        List.of(transaction),
                        null,
