...
class SemanticAuthorizationCompositionParityTest {
	...
	void compositionIsMonotonicAndCannotBroadenAccess() {
		...
		assertEquals(AuthorizationDecision.DENIED, SemanticAuthorizationCapabilityComposition
				.compose(AuthorizationDecision.ALLOWED, AuthorizationDecision.DENIED));
		assertEquals(AuthorizationDecision.DENIED, SemanticAuthorizationCapabilityComposition
				.compose(AuthorizationDecision.DENIED, AuthorizationDecision.ALLOWED));
	}
