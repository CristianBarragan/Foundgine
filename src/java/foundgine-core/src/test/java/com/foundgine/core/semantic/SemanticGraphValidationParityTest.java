...
/**
 * Port of {@code Foundgine.Core.Semantic.Tests.SemanticGraphValidationTests} (declared alongside
 * {@code SemanticSemanticContractTests} in the C# source file).
 */
    ...
    void resolverProvesRelationshipTargetConsistency() {
        ...
        var ex =
                assertThrows(
                        ...
                        () -> SemanticGraphValidator.validate(graph, model));
