...
class ProjectionPruningRuleParityTest {
    ...
    void removesDuplicateProjectionFieldsWithoutReorderingOutput() {
        var plan =
                createPlan(
                        List.of(new FieldId(1), new FieldId(2), new FieldId(1), new FieldId(3)),
                        null,
                        null);
        ...
        assertEquals(
                List.of(new FieldId(1), new FieldId(2), new FieldId(3)), rewritten.root().fields());
    }
    ...
    void retainsFieldsRequiredByFilter() {
        ...
        assertTrue(
                ProjectionPruningRequirements.requiredRootFields(rewritten.root())
                        .contains(new FieldId(7)));
    ...
    void rewritePreservesSecurityInvariants() {
        var plan =
                createPlan(
                        List.of(new FieldId(1), new FieldId(1)),
                        null,
    ...
    private static SemanticPlan createPlan(
            List<FieldId> fields, SemanticQueryOptions options, List<String> invariants) {
        var root =
