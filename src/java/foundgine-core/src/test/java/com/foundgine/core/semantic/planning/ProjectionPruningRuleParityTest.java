...
class ProjectionPruningRuleParityTest {
	...
	private static SemanticPlan createPlan(List<FieldId> fields, SemanticQueryOptions options,
			List<String> invariants) {
		var root = new SemanticPlanNode(1, ExecutionOperation.SCAN, new EntityId(1), fields, null, null, List.of(),
