...
class GroundingDecisionTest {
    ...
    void budgetExceededCannotCarryCommittedInterpretationByConstruction() {
        var decision = new GroundingDecision(
                "orders",
                ...
                "search stopped",
                List.of(),
                GroundingBudgetLimit.MAX_PATHS_EXPLORED,
                List.of(),
                null,
                List.of());
    ...
    void competingMeaningsAreDetectedWithoutTreatingRetrievalAsAuthorization() {
        var first = new GroundingInterpretation(
                List.of(), 0.91d, new EntityId(1L), "field:1", null);
        var second = new GroundingInterpretation(
                List.of(), 0.90d, new EntityId(1L), "field:2", null);
