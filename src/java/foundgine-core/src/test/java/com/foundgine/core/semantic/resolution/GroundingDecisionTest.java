...
class GroundingDecisionTest {
    ...
    void competingMeaningsAreDetectedWithoutTreatingRetrievalAsAuthorization() {
        var first =
                new GroundingInterpretation(List.of(), 0.91d, new EntityId(1L), "field:1", null);
        var second =
                new GroundingInterpretation(List.of(), 0.90d, new EntityId(1L), "field:2", null);
