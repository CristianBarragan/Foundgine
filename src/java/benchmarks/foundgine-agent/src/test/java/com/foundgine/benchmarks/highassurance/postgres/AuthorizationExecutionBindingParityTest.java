...
class AuthorizationExecutionBindingParityTest {
    ...
    void differentAmountCannotReuseAuthorizationEvidence() {
        var binding =
                AuthorizationExecutionBinding.create(
                        ACTOR, 7, command(new BigDecimal("10"), "k-1"), evidence(7, "fp-7"));
        assertThrows(
    ...
    void differentActorOrTenantCannotReuseBinding() {
        ...
        assertThrows(
                IllegalStateException.class,
                () -> binding.validateAgainst(ACTOR, 8, command, evidence(7, "fp-7")));
    }
    ...
    void deniedEvidenceCannotBeBound() {
        ...
        assertThrows(
                ...
                () ->
                        AuthorizationExecutionBinding.create(
                                ACTOR, 7, command(new BigDecimal("10"), "k-1"), denied));
    }
}
