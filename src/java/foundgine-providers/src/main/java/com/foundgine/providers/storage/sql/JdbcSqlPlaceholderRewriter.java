 ...
 *
 * <p>
 * The SQL compiler deliberately keeps named placeholders because they make the
 * provider plan and diagnostics deterministic. JDBC PreparedStatement, however,
 * is positional. The rewrite is therefore a physical-provider concern and does
 * not mutate the provider-neutral SQL plan.
 * </p>
 */
