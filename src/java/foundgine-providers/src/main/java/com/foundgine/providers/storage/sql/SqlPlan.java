...
public final class SqlPlan extends ProviderPlan {
    ...
    public SqlPlan(
            String commandText,
            List<SqlColumnBinding> columns,
            List<SqlParameterBinding> parameters,
            SqlPaginationPlan pagination,
    ...
    public SqlPlan(String commandText, List<SqlColumnBinding> columns) {
        this(commandText, columns, null, null, null);
    }
    ...
    public List<SqlColumnBinding> columns() {
        return columns;
    }
    ...
    public List<SqlParameterBinding> effectiveParameters() {
        return parameters;
    }

    public SqlPaginationPlan pagination() {
        return pagination;
    }

    public List<SqlAuthorizationPredicate> authorization() {
