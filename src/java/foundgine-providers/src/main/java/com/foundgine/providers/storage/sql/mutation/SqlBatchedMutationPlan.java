...
/**
 * Provider-specific PostgreSQL mutation plan containing one physical SQL command for a logical
 * batch.
 */
public final class SqlBatchedMutationPlan extends ProviderMutationBatchPlan {
    ...
    public SqlBatchedMutationPlan(
            String sql,
            List<SqlParameterBinding> parameters,
            List<GroupMeta> groups,
            List<RowKey> rowKeys,
            int operationCount,
            List<SqlMutationPlan> operations,
