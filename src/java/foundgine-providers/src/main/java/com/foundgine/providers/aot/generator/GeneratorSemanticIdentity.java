...
/**
 * Canonical semantic identity and stable hashing rules shared by AOT metadata
 * generation.
 */
public final class GeneratorSemanticIdentity {
	...
	public static String fieldKey(String entity, String field) {
		return key(FIELD_NAMESPACE, pair(entity, field));
	}

	public static String relationshipKey(String entity, String relationship) {
		return key(RELATIONSHIP_NAMESPACE, pair(entity, relationship));
	}
	...
	public static String connectionKey(String model, String connection) {
		return key(CONNECTION_NAMESPACE, pair(model, connection));
	}

	public static String authorizationKey(String declaringType, String authorization) {
		return key(AUTHORIZATION_NAMESPACE, pair(declaringType, authorization));
	}
