...
public final class SqlMutationBatchPlan extends ProviderMutationBatchPlan {
	private final List<SqlMutationPlan> operations;
	private final List<MutationDependency> dependencies;

	public SqlMutationBatchPlan(List<SqlMutationPlan> operations, List<MutationDependency> dependencies) {
		super(new ArrayList<>(operations));
		this.operations = List.copyOf(operations);
		this.dependencies = List.copyOf(dependencies);
	}

	public List<SqlMutationPlan> sqlOperations() {
		return operations;
	}
