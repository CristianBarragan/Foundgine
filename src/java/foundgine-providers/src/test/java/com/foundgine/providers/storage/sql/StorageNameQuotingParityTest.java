...
/**
 * Port of C# {@code Foundgine.E2E.Tests.StorageNameQuotingTests}: schema-qualified storage names
 * ("Banking.Customer") must be rendered as two separately quoted identifiers ({@code
 * "Banking"."Customer"}), not one identifier containing a literal dot.
 */
    ...
    void schemaQualifiedStorageNamesAreQuotedPerIdentifier() {
        ...
        metadata.register(
                new EntityMetadata(
                        ...
                        "Customer",
                        List.of(
                                new ColumnMetadata(customerIdColumn, "Id"),
                                new ColumnMetadata(customerNameColumn, "Name")),
                        "Banking.Customer",
                        List.of(
                                new FieldMetadata(
                                        CUSTOMER_ID,
        ...
        var plan =
                new SemanticPlan(
                        planned.root(),
                        planned.requiredSecurityInvariants(),
