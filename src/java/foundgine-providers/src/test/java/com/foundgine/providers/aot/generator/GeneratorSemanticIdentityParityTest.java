...
class GeneratorSemanticIdentityParityTest {
    ...
    void unrelatedModulesDoNotChangeExistingIdentity() {
        long customer =
                GeneratorSemanticIdentity.hash(GeneratorSemanticIdentity.entityKey("Customer"));
    ...
    void emptyIdentityComponentsFailClosed() {
        assertThrows(
                IllegalArgumentException.class, () -> GeneratorSemanticIdentity.entityKey(" "));
        assertThrows(
                IllegalArgumentException.class,
                () -> GeneratorSemanticIdentity.fieldKey("Customer", " "));
    }
}
