...
public class PostgresBatchedMutationCompilerParityTest {
	...
	void exposesExecutionIrEntryPoint() throws Exception {
		assertNotNull(PostgresBatchedMutationCompiler.class.getMethod("compile",
				com.foundgine.core.execution.mutation.ExecutionMutationIR.class));
		assertNotNull(PostgresBatchedMutationCompiler.class.getMethod("tryCompile",
				com.foundgine.core.execution.mutation.ExecutionMutationIR.class));
	}
	...
	void batchedCreateUsesExplicitCorrelationCarrier() {
		...
		MutationEntitySchema entity = new MutationEntitySchema(entityId, "Customer", Set.of(id, name),
				Map.of(idField, id, nameField, name), id);
		MutationBatchPlan plan = new MutationBatchPlan(List.of(
				new MutationOperation(entity, MutationKind.CREATE,
						List.of(new MutationFieldValue(id, 101L), new MutationFieldValue(name, "Alice")), null, null,
						List.of(idField, nameField)),
				new MutationOperation(entity, MutationKind.CREATE,
						List.of(new MutationFieldValue(id, 102L), new MutationFieldValue(name, "Bob")), null, null,
						List.of(idField, nameField))),
				List.of());
	...
	void generatedIdentityDoesNotBorrowUserVisibleKeyForCorrelation() {
		...
		MutationEntitySchema entity = new MutationEntitySchema(entityId, "Customer", Set.of(id, name),
				Map.of(idField, id, nameField, name), id);
		MutationBatchPlan plan = new MutationBatchPlan(List.of(
				new MutationOperation(entity, MutationKind.CREATE, List.of(new MutationFieldValue(name, "same")), null,
						null, List.of(idField, nameField)),
				new MutationOperation(entity, MutationKind.CREATE, List.of(new MutationFieldValue(name, "same")), null,
						null, List.of(idField, nameField))),
				List.of());
	...
	void tryCompileFallsBackForDuplicateLiteralUpsertKeys() {
		...
		MutationOperation a = new MutationOperation(entity, MutationKind.UPSERT,
				List.of(new MutationFieldValue(id, 7L), new MutationFieldValue(name, "a")), null, List.of(id),
				List.of(idField));
		MutationOperation b = new MutationOperation(entity, MutationKind.UPSERT,
				List.of(new MutationFieldValue(id, 7L), new MutationFieldValue(name, "b")), null, List.of(id),
				List.of(idField));
		assertNull(new PostgresBatchedMutationCompiler(metadata)
				.tryCompile(new MutationBatchPlan(List.of(a, b), List.of())));
	}
	...
	void dependencyLevelsCreateDistinctPhysicalGroupsAndCorrelationMetadata() {
		...
		metadata.register(new EntityMetadata(account, "Account",
				List.of(new ColumnMetadata(aId, "Id"), new ColumnMetadata(aCustomer, "CustomerId"),
						new ColumnMetadata(aName, "Name")),
				null,
				List.of(new FieldMetadata(aIdField, "Id", Long.class, new ColumnReference(account, aId)),
						new FieldMetadata(aCustomerField, "CustomerId", Long.class,
								new ColumnReference(account, aCustomer)),
		...
		MutationEntitySchema c = new MutationEntitySchema(customer, "Customer", Set.of(cId, cName),
				Map.of(cIdField, cId, cNameField, cName), cId);
		MutationEntitySchema a = new MutationEntitySchema(account, "Account", Set.of(aId, aCustomer, aName),
				Map.of(aIdField, aId, aCustomerField, aCustomer, aNameField, aName), aId);
		MutationOperation first = new MutationOperation(c, MutationKind.CREATE,
				List.of(new MutationFieldValue(cName, "Alice")), null, null, List.of(cIdField, cNameField));
		MutationOperation second = new MutationOperation(a, MutationKind.CREATE,
				List.of(MutationFieldValue.fromPrevious(aCustomer, 0, cIdField),
						new MutationFieldValue(aName, "Primary")),
		...
		SqlBatchedMutationPlan compiled = new PostgresBatchedMutationCompiler(metadata)
				.compile(new MutationBatchPlan(List.of(first, second), List.of(dependency)));
	...
	void tryCompileFallsBackWhenOneEntityMixesInsertAndUpdate() {
		...
		MutationOperation create = new MutationOperation(entity, MutationKind.CREATE,
				List.of(new MutationFieldValue(id, 1L), new MutationFieldValue(name, "created")), null, null,
				List.of(idField, nameField));
		...
		assertNull(new PostgresBatchedMutationCompiler(metadata)
				.tryCompile(new MutationBatchPlan(List.of(create, update), List.of())));
	}
	...
	void tryCompileRejectsDeleteAsGeneratedIdentityDependencySource() {
		...
		FieldId parentPkField = new FieldId(1), parentNameField = new FieldId(2), childPkField = new FieldId(3),
				childParentField = new FieldId(4);
		MetadataRegistry metadata = new MetadataRegistry();
		metadata.register(new EntityMetadata(parentId, "Parent",
				...
				List.of(new FieldMetadata(parentPkField, "Id", Long.class, new ColumnReference(parentId, parentPk)),
						new FieldMetadata(parentNameField, "Name", String.class,
								new ColumnReference(parentId, parentName))),
		...
		metadata.register(new EntityMetadata(childId, "Child",
				...
				List.of(new FieldMetadata(childPkField, "Id", Long.class, new ColumnReference(childId, childPk)),
						new FieldMetadata(childParentField, "ParentId", Long.class,
								new ColumnReference(childId, childParent))),
				new ColumnReference(childId, childPk), null, false, null, null));

		MutationEntitySchema parent = new MutationEntitySchema(parentId, "Parent", Set.of(parentPk, parentName),
				Map.of(parentPkField, parentPk, parentNameField, parentName), parentPk);
		MutationEntitySchema child = new MutationEntitySchema(childId, "Child", Set.of(childPk, childParent),
				Map.of(childPkField, childPk, childParentField, childParent), childPk);
		MutationOperation delete = new MutationOperation(parent, MutationKind.DELETE, List.of(),
				new SemanticFieldFilter(parentPkField, SemanticFilterOperator.EQ, 1L), null, List.of(parentPkField));
		MutationOperation createChild = new MutationOperation(child, MutationKind.CREATE,
				List.of(MutationFieldValue.fromPrevious(childParent, 0, parentPkField)), null, null,
				List.of(childPkField, childParentField));
		MutationDependency dependency = new MutationDependency(0, 1, parentPkField, childParent);

		assertNull(new PostgresBatchedMutationCompiler(metadata)
				.tryCompile(new MutationBatchPlan(List.of(delete, createChild), List.of(dependency))));
	}
	...
	void compiledPlanHasOneJdbcPlaceholderPerDeclaredParameter() {
		...
		MutationEntitySchema a = new MutationEntitySchema(account, "Account", Set.of(aId, aCustomer, aName),
				Map.of(aIdField, aId, aCustomerField, aCustomer, aNameField, aName), aId);
		MutationOperation alice = new MutationOperation(c, MutationKind.CREATE,
				List.of(new MutationFieldValue(cName, "Alice")), null, null, List.of(cIdField, cNameField));
		MutationOperation bob = new MutationOperation(c, MutationKind.CREATE,
				List.of(new MutationFieldValue(cName, "Bob")), null, null, List.of(cIdField, cNameField));
		MutationOperation accountForBob = new MutationOperation(a, MutationKind.CREATE,
				List.of(MutationFieldValue.fromPrevious(aCustomer, 1, cIdField),
						new MutationFieldValue(aName, "Primary")),
				null, null, List.of(aIdField, aCustomerField, aNameField));
	...
	void emptyBatchIsNotSilentlyAccepted() {
		MetadataRegistry metadata = new MetadataRegistry();
		assertThrows(IllegalStateException.class, () -> new PostgresBatchedMutationCompiler(metadata)
				.compile(new MutationBatchPlan(List.of(), List.of())));
	}

	private static MetadataRegistry simpleMetadata(EntityId entityId, String name, ColumnId id, ColumnId value,
