...
public class PostgresBatchedMutationCompilerParityTest {
    ...
    void exposesExecutionIrEntryPoint() throws Exception {
        assertNotNull(
                PostgresBatchedMutationCompiler.class.getMethod(
                        "compile",
    ...
    void batchedCreateUsesExplicitCorrelationCarrier() {
                ...
                new EntityMetadata(
                        ...
                        List.of(
                                new FieldMetadata(
                                        ...
                                        "Id",
                                        Long.class,
                                        new ColumnReference(entityId, id)),
                                new FieldMetadata(
                                        nameField,
                                        "Name",
                                        String.class,
                                        new ColumnReference(entityId, name))),
                        new ColumnReference(entityId, id),
                        null,
                        false,
                        null,
        ...
        MutationEntitySchema entity =
                new MutationEntitySchema(
                        ...
                        "Customer",
                        Set.of(id, name),
                        Map.of(idField, id, nameField, name),
                        id);
        MutationBatchPlan plan =
                new MutationBatchPlan(
                        List.of(
                                new MutationOperation(
                                        entity,
                                        MutationKind.CREATE,
                                        List.of(
                                                new MutationFieldValue(id, 101L),
                                                new MutationFieldValue(name, "Alice")),
                                        null,
                                        null,
                                ...
                                new MutationOperation(
                                        ...
                                        MutationKind.CREATE,
                                        List.of(
                                                new MutationFieldValue(id, 102L),
                                                new MutationFieldValue(name, "Bob")),
                                        null,
                                        null,
                                        List.of(idField, nameField))),
                        List.of());
                ...
                new MutationBatchPlan(
                        List.of(
                                new MutationOperation(
                                        entity,
                                        MutationKind.CREATE,
                                        List.of(new MutationFieldValue(name, "same")),
                                        null,
                                        null,
                                        List.of(idField, nameField)),
                                new MutationOperation(
    ...
    void tryCompileFallsBackForDuplicateLiteralUpsertKeys() {
        ...
        MutationOperation a =
                new MutationOperation(
                        entity,
                        MutationKind.UPSERT,
                        List.of(new MutationFieldValue(id, 7L), new MutationFieldValue(name, "a")),
                        null,
                        List.of(id),
                        List.of(idField));
        MutationOperation b =
                new MutationOperation(
                        entity,
                        MutationKind.UPSERT,
                        List.of(new MutationFieldValue(id, 7L), new MutationFieldValue(name, "b")),
                        null,
                        List.of(id),
                        List.of(idField));
        assertNull(
                new PostgresBatchedMutationCompiler(metadata)
    ...
    void dependencyLevelsCreateDistinctPhysicalGroupsAndCorrelationMetadata() {
        ...
        FieldId aIdField = new FieldId(3),
                aCustomerField = new FieldId(4),
                aNameField = new FieldId(5);
        MetadataRegistry metadata = new MetadataRegistry();
        metadata.register(
                new EntityMetadata(
                        customer,
                        "Customer",
                        List.of(new ColumnMetadata(cId, "Id"), new ColumnMetadata(cName, "Name")),
                        null,
                        List.of(
                                new FieldMetadata(
                                        cIdField,
                                        "Id",
                                        Long.class,
                                        new ColumnReference(customer, cId)),
                                new FieldMetadata(
                                        cNameField,
                                        "Name",
                                        String.class,
                                        new ColumnReference(customer, cName))),
                        new ColumnReference(customer, cId),
                        null,
                        false,
                        null,
        ...
        metadata.register(
                new EntityMetadata(
                        ...
                        "Account",
                        List.of(
                                new ColumnMetadata(aId, "Id"),
                                new ColumnMetadata(aCustomer, "CustomerId"),
                        ...
                        List.of(
                                new FieldMetadata(
                                        ...
                                        "Id",
                                        Long.class,
                                        new ColumnReference(account, aId)),
                                new FieldMetadata(
                                        aCustomerField,
                                        "CustomerId",
                                        Long.class,
                                ...
                                new FieldMetadata(
                                        ...
                                        "Name",
                                        String.class,
                                        new ColumnReference(account, aName))),
                        new ColumnReference(account, aId),
                        null,
                        false,
                        null,
                        null));
        MutationEntitySchema c =
                new MutationEntitySchema(
                        customer,
                        "Customer",
                        Set.of(cId, cName),
                        Map.of(cIdField, cId, cNameField, cName),
                        cId);
        MutationEntitySchema a =
                new MutationEntitySchema(
                        account,
                        "Account",
                        Set.of(aId, aCustomer, aName),
                        Map.of(aIdField, aId, aCustomerField, aCustomer, aNameField, aName),
                        aId);
        MutationOperation first =
                new MutationOperation(
                        c,
                        MutationKind.CREATE,
                        List.of(new MutationFieldValue(cName, "Alice")),
                        null,
                        null,
                        List.of(cIdField, cNameField));
        MutationOperation second =
                new MutationOperation(
                        a,
                        MutationKind.CREATE,
                        List.of(
                                MutationFieldValue.fromPrevious(aCustomer, 0, cIdField),
                                new MutationFieldValue(aName, "Primary")),
                        null,
                        null,
                        List.of(aIdField, aCustomerField, aNameField));
        MutationDependency dependency = new MutationDependency(0, 1, cIdField, aCustomer);
        SqlBatchedMutationPlan compiled =
                new PostgresBatchedMutationCompiler(metadata)
                        .compile(
                                new MutationBatchPlan(List.of(first, second), List.of(dependency)));
    ...
    void tryCompileFallsBackWhenOneEntityMixesInsertAndUpdate() {
        ...
        MetadataRegistry metadata =
                simpleMetadata(entityId, "Customer", id, name, idField, nameField);
        MutationEntitySchema entity =
                new MutationEntitySchema(
                        entityId,
                        "Customer",
        ...
        MutationOperation create =
                new MutationOperation(
                        ...
                        MutationKind.CREATE,
                        List.of(
                                new MutationFieldValue(id, 1L),
                                new MutationFieldValue(name, "created")),
                        null,
                        null,
                        List.of(idField, nameField));
        MutationOperation update =
                new MutationOperation(
                        ...
                        new SemanticFieldFilter(idField, SemanticFilterOperator.EQ, 1L),
                        null,
                        List.of(nameField));
    ...
    void tryCompileRejectsDeleteAsGeneratedIdentityDependencySource() {
        ...
        FieldId parentPkField = new FieldId(1),
                parentNameField = new FieldId(2),
                childPkField = new FieldId(3),
        ...
        metadata.register(
                new EntityMetadata(
                        ...
                        "Parent",
                        List.of(
                                new ColumnMetadata(parentPk, "Id"),
                                new ColumnMetadata(parentName, "Name")),
                        null,
                        List.of(
                                new FieldMetadata(
                                        parentPkField,
                                        "Id",
                                        Long.class,
                                        new ColumnReference(parentId, parentPk)),
                                new FieldMetadata(
                                        parentNameField,
                                        "Name",
                                        String.class,
        ...
        metadata.register(
                new EntityMetadata(
                        ...
                        "Child",
                        List.of(
                                new ColumnMetadata(childPk, "Id"),
                                new ColumnMetadata(childParent, "ParentId")),
                        null,
                        List.of(
                                new FieldMetadata(
                                        childPkField,
                                        "Id",
                                        Long.class,
                                        new ColumnReference(childId, childPk)),
                                new FieldMetadata(
                                        childParentField,
                                        "ParentId",
                                        Long.class,
        ...
        MutationEntitySchema parent =
                new MutationEntitySchema(
                        parentId,
                        "Parent",
                        Set.of(parentPk, parentName),
                        Map.of(parentPkField, parentPk, parentNameField, parentName),
                        parentPk);
        MutationEntitySchema child =
                new MutationEntitySchema(
                        childId,
                        "Child",
                        Set.of(childPk, childParent),
                        Map.of(childPkField, childPk, childParentField, childParent),
                        childPk);
        MutationOperation delete =
                new MutationOperation(
                        ...
                        MutationKind.DELETE,
                        List.of(),
                        new SemanticFieldFilter(parentPkField, SemanticFilterOperator.EQ, 1L),
                        null,
                        List.of(parentPkField));
        MutationOperation createChild =
                new MutationOperation(
                        child,
                        MutationKind.CREATE,
                        List.of(MutationFieldValue.fromPrevious(childParent, 0, parentPkField)),
                        null,
                        null,
        ...
        assertNull(
                new PostgresBatchedMutationCompiler(metadata)
                        .tryCompile(
                                new MutationBatchPlan(
                                        List.of(delete, createChild), List.of(dependency))));
    }
    ...
    void compiledPlanHasOneJdbcPlaceholderPerDeclaredParameter() {
        ...
        MutationOperation alice =
                new MutationOperation(
                        ...
                        null,
                        List.of(cIdField, cNameField));
        MutationOperation bob =
                new MutationOperation(
                        c,
                        MutationKind.CREATE,
                        List.of(new MutationFieldValue(cName, "Bob")),
                        null,
                        null,
                        List.of(cIdField, cNameField));
        MutationOperation accountForBob =
                new MutationOperation(
                        a,
                        MutationKind.CREATE,
                        List.of(
                                MutationFieldValue.fromPrevious(aCustomer, 1, cIdField),
                                new MutationFieldValue(aName, "Primary")),
                        null,
                        null,
                        List.of(aIdField, aCustomerField, aNameField));
        ...
        SqlBatchedMutationPlan compiled =
                new PostgresBatchedMutationCompiler(metadata)
                        .compile(
                                new MutationBatchPlan(
                                        List.of(alice, bob, accountForBob), List.of(dependency)));

        assertEquals(3, compiled.parameters().size());
        String jdbcSql =
                com.foundgine.providers.storage.sql.JdbcSqlPlaceholderRewriter.rewrite(
                        compiled.commandText());
        long placeholderCount = jdbcSql.chars().filter(ch -> ch == '?').count();
        assertEquals(
                compiled.parameters().size(),
                placeholderCount,
                "Declared parameter count must match the number of JDBC '?' placeholders in the"
                        + " rewritten SQL");
    }
    ...
    private static MetadataRegistry simpleMetadata(
            EntityId entityId,
            String name,
            ColumnId id,
            ColumnId value,
        ...
        metadata.register(
                new EntityMetadata(
                        entityId,
                        name,
                        List.of(new ColumnMetadata(id, "Id"), new ColumnMetadata(value, "Name")),
                        null,
                        List.of(
                                new FieldMetadata(
                                        idField,
                                ...
                                new FieldMetadata(
                                        ...
                                        "Name",
                                        String.class,
                                        new ColumnReference(entityId, value))),
                        new ColumnReference(entityId, id),
                        null,
                        false,
                        null,
