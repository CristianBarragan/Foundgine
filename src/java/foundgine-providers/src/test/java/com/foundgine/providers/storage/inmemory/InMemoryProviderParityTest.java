        ...
        var options =
                new SemanticQueryOptions(
                        new SemanticFieldFilter(
                                CUSTOMER_ID, SemanticFilterOperator.IN, List.of(2, 3, 4)),
    ...
    void relationship_traversal_uses_metadata_join_keys_without_leaking_the_join_key() {
        ...
        var data =
                new InMemoryDataSet()
                        .add(
                                new InMemoryRow(
                                        CUSTOMER, Map.of(CUSTOMER_ID, 1, CUSTOMER_NAME, "Alice")))
                        .add(
                                new InMemoryRow(
                                        ACCOUNT,
                                        Map.of(
        ...
        assertFalse(
                row.effectiveCells().keySet().stream()
    ...
    private static MetadataRegistry customerMetadata() {
        ...
        metadata.register(
                new EntityMetadata(
                        ...
                        "Customer",
                        List.of(
                                new ColumnMetadata(col(11), "Id"),
                                new ColumnMetadata(col(12), "Name")),
                        null,
                        List.of(
                                new FieldMetadata(
                                        CUSTOMER_ID, "Id", Integer.class, ref(CUSTOMER, 11)),
                                new FieldMetadata(
                                        CUSTOMER_NAME, "Name", String.class, ref(CUSTOMER, 12))),
                        ref(CUSTOMER, 11),
                        null,
                        false,
                        null,
    ...
    private static MetadataRegistry customerAndAccountMetadata() {
        ...
        metadata.register(
                new EntityMetadata(
                        ...
                        "Account",
                        List.of(
                                new ColumnMetadata(col(21), "Id"),
                                new ColumnMetadata(col(22), "Balance"),
                                new ColumnMetadata(col(23), "CustomerId")),
                        null,
                        List.of(
                                new FieldMetadata(
                                        ACCOUNT_ID, "Id", Integer.class, ref(ACCOUNT, 21)),
                                new FieldMetadata(
                                        BALANCE, "Balance", BigDecimal.class, ref(ACCOUNT, 22)),
                                new FieldMetadata(
                                        ACCOUNT_CUSTOMER_ID,
                                        "CustomerId",
                                        Integer.class,
