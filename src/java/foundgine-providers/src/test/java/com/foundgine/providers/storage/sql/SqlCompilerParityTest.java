...
/**
 * Provider-level SQL rendering contracts mirrored from the C# E2E SQL pipeline suite. These tests
 * intentionally inspect the provider-neutral plan -> physical SQL boundary without requiring a live
 * database.
 */
class SqlCompilerParityTest {
    ...
    void aggregateCountGreaterThanZeroUsesCountByDefault() {
        ...
        var sql =
                compile(new SemanticQueryOptions(filter, List.of(), null, null, null))
                        .commandText();
    ...
    void optimizedAggregateCountGreaterThanZeroUsesExists() {
        ...
        var node =
                new SemanticPlanNode(
                        ...
                        null,
                        List.of(),
                        new SemanticQueryOptions(filter, null, null, null, null),
                        null,
                        null,
                        null,
                        -1,
                        ...
                        .compile(
                                new SemanticPlan(
                                        ...
                                        new SemanticPlanAuthorizationBinding(
                                                "test-contract", "test-authorization")))
                        .commandText();
    ...
    private static SqlPlan compile(SemanticQueryOptions options) {
        var node =
                new SemanticPlanNode(
                        ...
                        0,
                        null);
        return new SqlCompiler(metadata())
                .compile(
                        new SemanticPlan(
                                node,
                                List.of(),
    ...
    private static MetadataRegistry metadata(String customerStorage, String accountStorage) {
        ...
        registry.register(
                new EntityMetadata(
                        ...
                        "Customer",
                        List.of(
                                new ColumnMetadata(customerId, "Id"),
                                new ColumnMetadata(customerName, "Name")),
                        customerStorage,
                        List.of(
                                new FieldMetadata(
                                        CUSTOMER_ID,
