                        ...
                        exchange -> {
                            ...
                            if (body.contains("foundgine_capabilities")) {
                                reply(
                                        exchange,
                                        rpc(
                                                "{\"version\":1,\"capabilities\":[{\"id\":\"Customer.read\",\"name\":\"Read"
                                                    + " Customer\",\"targetEntityId\":1,\"access\":{\"access\":\"ALLOWED\",\"predicate\":null},\"inputs\":[],\"constraints\":[],\"effects\":[],\"fields\":[\"Id\",\"Name\"],\"relationships\":[\"Transactions\"],\"operation\":\"read\",\"hasSideEffects\":false,\"isIdempotent\":false,\"version\":1,\"requiredSecurityInvariants\":[]}]}"));
                            } else {
    ...
    void sseToolResultIsUnwrapped() throws Exception {
        try (TestServer server =
            ...
            var result =
                    client.executeQuery(
                                    new ReadIntent(
                                            "Customer", java.util.List.of(new ReadSelection("Id"))))
                            .toCompletableFuture()
                            .get(5, TimeUnit.SECONDS);
