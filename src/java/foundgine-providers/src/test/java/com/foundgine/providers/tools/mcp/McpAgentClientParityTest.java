    ...
    void discoveryThenDynamicIntentThenExecutionUsesDiscoveredContract() throws Exception {
        ...
        try (TestServer server = new TestServer(exchange -> {
            ...
            if (body.contains("foundgine_capabilities")) {
                reply(exchange, rpc("{\"version\":1,\"capabilities\":[{\"id\":\"Customer.read\",\"name\":\"Read Customer\",\"targetEntityId\":1,\"access\":{\"access\":\"ALLOWED\",\"predicate\":null},\"inputs\":[],\"constraints\":[],\"effects\":[],\"fields\":[\"Id\",\"Name\"],\"relationships\":[\"Transactions\"],\"operation\":\"read\",\"hasSideEffects\":false,\"isIdempotent\":false,\"version\":1,\"requiredSecurityInvariants\":[]}]}"));
            } else {
