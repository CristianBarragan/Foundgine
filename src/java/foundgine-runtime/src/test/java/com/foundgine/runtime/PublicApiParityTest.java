...
/**
 * Mirrors C# {@code Foundgine.E2E.Tests.PublicApiTests}: the application-facing facade must not
 * require callers to manually orchestrate resolution, authorization, planning, or provider
 * compilation.
 *
 * <p>Java has no {@code Microsoft.Extensions.DependencyInjection} equivalent built in, so this
 * ports through {@link FoundgineServiceRegistry} + {@link
 * FoundgineServiceCollectionExtensions#addFoundgine}, which is the framework-neutral Java
 * counterpart of the C# {@code AddFoundgine} DI extension methods.
 */
class PublicApiParityTest {
    ...
    void publicFacadeExecutesTheCorePipelineThroughDi() {
        ...
        FoundgineServiceCollectionExtensions.addFoundgine(
                services, model, policy, compiler, provider);
                ...
                new SemanticRequest(
                        ...
                        List.of(
                                new SemanticSelection(
                                        FieldId.create("Customer", "Name"), null, List.of())),
                        null,
                        null);
    ...
    private static final class TestExecutionProvider implements IExecutionProvider {
        ...
        public java.util.concurrent.CompletionStage<ExecutionResult> executeAsync(
            ...
            return java.util.concurrent.CompletableFuture.completedFuture(
                    new ExecutionResult(List.of(new ExecutionRow(Map.of("Name", "Alice")))));
        }
    }
