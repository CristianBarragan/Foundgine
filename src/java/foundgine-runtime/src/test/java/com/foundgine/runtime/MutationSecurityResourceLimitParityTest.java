...
class MutationSecurityResourceLimitParityTest {
    ...
    void rejectsExcessiveDependencies() {
        ...
        var request =
                new SemanticMutationRequest(
                        new SemanticMutationOperationGraph(List.of(first, second)));
        var d = SecurityResourceLimits.defaults();
        var limits =
                copy(
                        d,
    ...
    private static SemanticMutationOperation operation() {
        return new SemanticMutationOperation(
                ENTITY,
                SemanticMutationKind.CREATE,
                List.of(new SemanticMutationField(new FieldId(1), "x")),
                null,
                List.of(),
                List.of(),
                List.of(),
    ...
    private static SecurityResourceLimits copy(
            SecurityResourceLimits d, int ops, int fields, int returns, int deps, int effects) {
