...
class PlanApprovalParityE2ETest {
    ...
    void approvalRejectsWhenSemanticVersionChanges() {
        ...
        var tampered =
                new PlanApproval(
                        ...
                        "sha256:changed",
                        approval.capabilityContractVersion(),
                        approval.capabilityVersion(),
                        approval.intentVersion(),
    ...
    void approvalRejectsWhenPlanFingerprintChanges() {
        ...
        var tampered =
                new PlanApproval(
                        approval.request(),
                        approval.approvalId(),
                        approval.planFingerprint() + "-tampered",
                        approval.semanticModelVersion(),
                        approval.capabilityContractVersion(),
                        approval.capabilityVersion(),
                        approval.intentVersion(),
                        approval.planVersion(),
    ...
    private static FoundgineEngine createEngine(CountingProvider provider) {
        ...
        return new FoundgineEngine(
                ...
                new com.foundgine.core.semantic.planning.Planner(),
                new TestCompiler(),
                provider);
    }
    ...
    private static SemanticRequest request() {
        return new SemanticRequest(
                EntityId.create("Customer"),
                List.of(new SemanticSelection(FieldId.create("Customer", "Id"), null, List.of())),
                null,
                null);
    }
    ...
    private static final class CountingProvider implements IExecutionProvider {
        ...
        public java.util.concurrent.CompletionStage<ExecutionResult> executeAsync(
            ...
            var evidence =
                    com.foundgine.core.execution.ExecutionEvidenceFactory.create(
                            "test", "placeholder", List.of(1), 1, 0, null);
            return java.util.concurrent.CompletableFuture.completedFuture(
                    new ExecutionResult(
                            List.of(new ExecutionRow(java.util.Map.of("Id", 1))),
                            null,
                            evidence,
                            null));
        }
