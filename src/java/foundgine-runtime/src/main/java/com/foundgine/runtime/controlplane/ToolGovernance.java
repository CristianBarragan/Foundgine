...
/**
 * Port of {@code
 * Foundgine.Runtime.ControlPlane.ToolGovernanceServiceCollectionExtensions.AddFoundgineToolGovernance},
 * the static entry point. See {@link ToolGovernanceBuilder} for the porting decision replacing DI
 * registration with direct assembly.
 */
