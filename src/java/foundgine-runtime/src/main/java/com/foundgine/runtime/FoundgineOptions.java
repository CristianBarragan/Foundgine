 ...
 *
 * <p>
 * This is the Java counterpart of the C# {@code FoundgineOptions}. The hosting
 * layer is intentionally framework-neutral; use
 * {@link FoundgineServiceRegistry} to adapt registrations to Spring, CDI,
 * Micronaut, or another application container.
 */
public final class FoundgineOptions {
	...
	private BiFunction<com.foundgine.core.semantic.authorization.SemanticAuthorizationEvidence, CancellationToken, ExecutionAuthorizationAuthorityState> executionAuthorizationAuthorityResolver;
	...
	public BiFunction<SemanticAuthorizationEvidence, CancellationToken, ExecutionAuthorizationAuthorityState> executionAuthorizationAuthorityResolver() {
	...
	public com.foundgine.core.execution.mutation.IMutationBatchExecutionProvider mutationProvider() {
