 ...
 *
 * <p><b>Porting decision:</b> the C# member {@code bool TryGet(string, out ApprovalRequest?)}
 * has no direct Java equivalent (Java has no {@code out} parameters). It is
 * ported as {@link #tryGet(String)} returning {@code Optional<ApprovalRequest>};
 * an empty {@code Optional} corresponds to the C# method returning {@code false}.
 */
