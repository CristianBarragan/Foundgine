...
public interface IFoundgineExecutor {
 ...
 default CompletableFuture<ExecutionResult> executeAsync(SemanticRequest request){return executeAsync(request,null);}
 default CompletableFuture<ExecutionResult> executeAsync(ReadIntent intent){return executeAsync(intent,null);}
}
