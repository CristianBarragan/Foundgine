...
/** Context supplied to an enabled Foundgine capability during startup configuration. */
public final class FoundgineCapabilityContext {
    ...
    public FoundgineOptions options() { return options; }
    public FoundgineServiceRegistry services() { return services; }
}
