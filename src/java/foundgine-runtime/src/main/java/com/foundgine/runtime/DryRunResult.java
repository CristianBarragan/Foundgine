 ...
 *
 * <p>
 * C#'s {@code ExecutionRequiredApproval = false} default parameter is ported as
 * a two-constructor pair, matching this port's established convention for
 * optional-parameter C# constructors.
 */
