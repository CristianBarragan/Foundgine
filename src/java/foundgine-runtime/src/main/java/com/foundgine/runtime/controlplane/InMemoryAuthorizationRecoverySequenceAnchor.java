...
/**
 * Port of
 * {@code Foundgine.Runtime.ControlPlane.InMemoryAuthorizationRecoverySequenceAnchor}.
 *
 * <p>
 * Test/reference anchor. Production deployments must replace this with
 * independent durable storage.
 *
 * <p>
 * <b>Porting decision:</b> C#'s {@code Interlocked.Read} /
 * {@code Interlocked.CompareExchange} over a {@code long} field are ported as
 * {@link AtomicLong#get()} and {@link AtomicLong#compareAndSet}, the direct
 * Java equivalents.
 */
