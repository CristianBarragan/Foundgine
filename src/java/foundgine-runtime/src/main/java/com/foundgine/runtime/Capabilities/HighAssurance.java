 ...
 *
 * <p>The generated key material is process-local and therefore intentionally
 * unsuitable for production. Production applications should configure a
 * durable/trusted key resolver and replay store before enabling this capability.
 */
