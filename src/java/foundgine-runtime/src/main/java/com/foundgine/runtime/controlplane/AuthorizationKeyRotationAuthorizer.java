 ...
 *
 * <p>External key-lifecycle authority. Operator credentials are represented
 * only by their fingerprints; credential material is never persisted in
 * PostgreSQL.
 *
 * <p><b>Porting decision:</b> {@code CryptographicOperations.FixedTimeEquals}
 * over the UTF-8 bytes of the two fingerprints is ported as
