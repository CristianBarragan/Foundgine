 ...
 *
 * <p>
 * Open, fluent query authoring surface entry point, provided as a pair of
 * static factories taking the receiver as an explicit first parameter.
 * {@link #typedQuery} additionally takes the entity's semantic name explicitly
 * — see {@link TypedQuery} for the design behind its
