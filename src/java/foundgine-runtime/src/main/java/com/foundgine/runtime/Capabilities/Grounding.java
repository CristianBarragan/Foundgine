...
/**
 * Optional capability wiring the lexical grounding services into a framework-neutral service
 * registry.
 */
public final class Grounding implements IFoundgineCapability {
    ...
    public void configure(FoundgineCapabilityContext context) {
        ...
        services.addSingleton(
                SemanticLexicalResolver.class,
                () ->
                        new SemanticLexicalResolver(
                                services.getRequiredService(
                                        com.foundgine.core.semantic.SemanticContractSnapshot.class),
                                services.getRequiredService(
                                        ISemanticLexicalCandidateSource.class)));
        services.addSingleton(
                SemanticLexicalReadIntentGrounder.class,
                () ->
