...
/**
 * Port of
 * {@code Foundgine.Runtime.ControlPlane.ToolRegistry.InMemoryToolRegistry},
 ...
 * distributed deployment should back {@link IToolRegistry} with a shared store
 * instead, the same substitution pattern used by {@code IProviderPlanCache} /
 * {@code MemoryProviderPlanCache} in {@code Foundgine.Core}.
 *
 * <p>
 * <b>Porting decision:</b> the C# constructor takes an optional
 * {@code IEnumerable<ToolDescriptor>? seed}, immediately registered. Java ports
 * this as two constructors (no-arg, and one taking an explicit seed list)
 * rather than a nullable default parameter. {@code System.Threading.Lock} is
 * ported as a plain {@code Object} monitor guarded with {@code synchronized},
...
public final class InMemoryToolRegistry implements IToolRegistry {
	...
	/**
	 * @param seed descriptors to register immediately, e.g. from collected
	 *             {@code ToolDescriptor} registrations made via tool-governance
	 *             builder setup.
	 */
