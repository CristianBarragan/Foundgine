 ...
 *
 * <p><b>Porting decision:</b> {@code bool TryGet(string, out ToolDescriptor?)} is ported as {@link
 * #tryGet(String)} returning {@code Optional<ToolDescriptor>}, the same substitution used for
 * {@code IApprovalStore.TryGet}.
 */
