 ...
 *
 * <p>Durable monotonic anchor for recovery checkpoints. In production this
 * must be backed by storage whose rollback/fork guarantees are stronger
 * than the PostgreSQL database being protected (for example a managed
 * KMS/HSM, append-only ledger, or independent control plane).
 *
 * <p><b>Porting decision:</b> {@code ValueTask<T>} is ported as
