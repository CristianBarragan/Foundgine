...
public static class CoffeeBeanerySemanticModel
{
    public static readonly EntityId Customer = new(1);
    public static readonly EntityId CustomerBankingRelationship = new(2);
    public static readonly EntityId Contract = new(3);
    public static readonly EntityId Transaction = new(4);

    public static readonly RelationshipId CustomerRelationships = new(1);
