...
Generated: `2026-09-01T10:44:57.7270919+00:00`  
Mode: `replay`  
Concurrency: `32`; runs: `30` measured / `5` warmups; fixture customer `1`
...
|-------------------------------|-------------:|----------:|
| Wall clock (ms)               |         61.7 |      59.7 |
| Model time (ms)               |          0.0 |       0.0 |
| Tool time (ms)                |         56.3 |      54.5 |
| Success rate (%)              |        100.0 |     100.0 |
| p50 wall (ms)                 |         60.0 |      59.6 |
| p95 wall (ms)                 |         86.1 |      73.4 |
| p99 wall (ms)                 |        105.8 |      79.5 |
| Peak active HTTP requests     |          0.0 |      32.0 |
| HTTP retries                  |          0.0 |       0.0 |
| Model calls                   |          0.0 |       0.0 |
| Tool calls                    |          9.0 |       6.0 |
| Agent/tool round trips        |          9.0 |       6.0 |
| Agent/tool payload bytes      |       3436.1 |     747.8 |
| Estimated tool-input tokens   |         61.2 |      33.1 |
| Estimated tool-output tokens  |        798.6 |     156.2 |
| Estimated context-load tokens |       1165.9 |     502.4 |
...
|   9 | Conventional |        5 | PASS  | —                                        |
|   9 | Conventional |        6 | PASS  | —                                        |
|   9 | Conventional |        7 | FAIL  | FullName: expected=Customer 7 Benchmark  | Reviewed | Remediation Complete, actual=Customer 7 Benchmark | Reviewed |
|   9 | Conventional |        8 | PASS  | —                                        |
|   9 | Conventional |        9 | PASS  | —                                        |
|   9 | Conventional |       10 | PASS  | —                                        |
|   9 | Conventional |        1 | PASS  | —                                        |
...
|  15 | Conventional |        3 | PASS  | —                                        |
|  15 | Conventional |        4 | PASS  | —                                        |
|  15 | Conventional |        5 | FAIL  | FullName: expected=Customer 5 Benchmark  | Reviewed | Remediation Complete, actual=Customer 5 Benchmark | Reviewed |
|  15 | Conventional |        6 | PASS  | —                                        |
|  15 | Conventional |        7 | PASS  | —                                        |
|  15 | Conventional |        8 | PASS  | —                                        |
...
|  21 | Conventional |        6 | FAIL  | FullName: expected=Customer 6 Benchmark  | Reviewed | Remediation Complete, actual=Customer 6 Benchmark | Reviewed |
...
|   9 | Foundgine    |        3 | PASS  | —                                        |
|   9 | Foundgine    |        4 | PASS  | —                                        |
|   9 | Foundgine    |        5 | FAIL  | FullName: expected=Customer 5 Benchmark  | Reviewed | Remediation Complete, actual=Customer 5 Benchmark | Reviewed |
|   9 | Foundgine    |        6 | PASS  | —                                        |
|   9 | Foundgine    |        7 | PASS  | —                                        |
|   9 | Foundgine    |        8 | PASS  | —                                        |
|   9 | Foundgine    |        9 | PASS  | —                                        |
...
|  15 | Foundgine    |        7 | PASS  | —                                        |
|  15 | Foundgine    |        8 | PASS  | —                                        |
|  15 | Foundgine    |        9 | FAIL  | FullName: expected=Customer 9 Benchmark  | Reviewed | Remediation Complete, actual=Customer 9 Benchmark | Reviewed |
...
|  17 | Foundgine    |        5 | PASS  | —                                        |
|  17 | Foundgine    |        6 | PASS  | —                                        |
|  17 | Foundgine    |        7 | FAIL  | FullName: expected=Customer 7 Benchmark  | Reviewed | Remediation Complete, actual=Customer 7 Benchmark | Reviewed |
|  17 | Foundgine    |        8 | PASS  | —                                        |
|  17 | Foundgine    |        9 | PASS  | —                                        |
