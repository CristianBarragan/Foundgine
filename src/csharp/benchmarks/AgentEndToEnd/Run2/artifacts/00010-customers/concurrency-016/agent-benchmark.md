...
Generated: `2026-09-01T10:44:49.1736381+00:00`  
Mode: `replay`  
...
|-------------------------------|-------------:|----------:|
| Wall clock (ms)               |         31.6 |      34.5 |
| Model time (ms)               |          0.0 |       0.0 |
| Tool time (ms)                |         28.1 |      30.8 |
| Success rate (%)              |        100.0 |     100.0 |
| p50 wall (ms)                 |         31.2 |      34.3 |
| p95 wall (ms)                 |         37.2 |      42.8 |
| p99 wall (ms)                 |         44.8 |      47.4 |
| Peak active HTTP requests     |          0.0 |      16.0 |
| HTTP retries                  |          0.0 |       0.0 |
| Model calls                   |          0.0 |       0.0 |
| Tool calls                    |          9.0 |       6.0 |
| Agent/tool round trips        |          9.0 |       6.0 |
| Agent/tool payload bytes      |       3432.3 |     747.5 |
| Estimated tool-input tokens   |         61.1 |      33.1 |
| Estimated tool-output tokens  |        797.8 |     156.1 |
