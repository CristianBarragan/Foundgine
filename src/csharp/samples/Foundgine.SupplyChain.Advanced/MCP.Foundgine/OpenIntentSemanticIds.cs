...
public static class OpenIntentSemanticIds
{
    ...
    public static EntityId Entity(string name) =>
        Metadata.Entities.Single(e => string.Equals(e.Name, name, StringComparison.OrdinalIgnoreCase)).EntityId;

    public static FieldId Field(string entity, string field) =>
        Metadata.Entities.Single(e => string.Equals(e.Name, entity, StringComparison.OrdinalIgnoreCase))
            .EffectiveFields.Single(f => string.Equals(f.Name, field, StringComparison.OrdinalIgnoreCase)).Id;
    ...
    public static RelationshipId Relationship(string entity, string relationship) =>
        Metadata.Relationships.Single(r =>
            ...
            string.Equals(Metadata.Entities.Single(e => e.EntityId == r.Source).Name, entity, StringComparison.OrdinalIgnoreCase)).Id;
}
