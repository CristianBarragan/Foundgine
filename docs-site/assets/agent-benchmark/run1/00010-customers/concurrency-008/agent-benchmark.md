...
Generated: `2026-09-01T11:21:44.1448927+00:00`  
Mode: `replay`  
Runs: `30` measured / `5` warmups
...
- Estimated context-load saving (heuristic, all modes): **66.7%** — see "Tokens vs. API time vs. application load" below.
- Tool-call saving: **42.9%**
- Model-call saving: **0.0%**
- Wall-clock change: **32.4%**
...
| -------------------------------------------------------- | -----------: | --------: |
| Wall clock (ms)                                          |         13.3 |      17.6 |
| Model time (ms)                                          |          0.0 |       0.0 |
| Tool time (ms)                                           |         79.1 |     102.9 |
| Model calls                                              |          0.0 |       0.0 |
| Tool calls                                               |         56.0 |      32.0 |
| Input tokens                                             |          0.0 |       0.0 |
| Output tokens                                            |          0.0 |       0.0 |
| Total tokens                                             |          0.0 |       0.0 |
| Cached input tokens                                      |          0.0 |       0.0 |
| Estimated tool-input tokens (heuristic)                  |        288.0 |     152.0 |
| Estimated tool-output tokens (heuristic)                 |       5808.0 |     896.0 |
| Estimated context load (heuristic, incl. system+request) |       7568.0 |    2520.0 |
...
- **Application load** (`ToolTimeMs`, `WallClockMs`, CPU, memory) measures how long and how much compute the _application side_ — the tool calls, the database, the semantic engine — spent doing the work the agent asked for. This can go up even when tokens go down: Foundgine's `WallClockMs` was higher than the conventional flow's in this replay precisely because it front-loads more resolution work into the application boundary so the agent doesn't have to.
